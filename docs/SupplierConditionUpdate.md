# SimpleBillyApi.SupplierConditionUpdate

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**currency** | **String** | Currency for the minimum order value. | [optional] 
...
**paymentDueDays** | **Number** | Number of days within which payment is due. | [optional] 
**paymentTerms** | **String** | Payment terms, e.g. \&quot;14 Tage, 2% Skonto\&quot;. | [optional] 
**supplierContactId** | **String** | The supplier this condition applies to (&#x60;contact_id&#x60;). References the supplier entity. | [optional] 
