...
The package is published to the JavaScript package registry. See the
[Releases](https://github.com/simplebilly/simplebilly-javascript/releases) page for the list
of versions.
