...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AdminApi();
  });
  ...
  describe('AdminApi', function() {
    describe('triggerMirror', function() {
      it('should call triggerMirror successfully', function(done) {
        //uncomment below and update the code to test triggerMirror
        //instance.triggerMirror(function(error) {
