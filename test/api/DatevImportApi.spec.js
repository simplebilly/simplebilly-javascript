...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DatevImportApi();
  });
  ...
  describe('DatevImportApi', function() {
    describe('datevImportApi', function() {
      it('should call datevImportApi successfully', function(done) {
        //uncomment below and update the code to test datevImportApi
        //instance.datevImportApi(function(error) {
