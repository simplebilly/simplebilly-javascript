...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ProductCategoryApi();
  });
  ...
  describe('ProductCategoryApi', function() {
    ...
    describe('getProductCategory', function() {
      it('should call getProductCategory successfully', function(done) {
        //uncomment below and update the code to test getProductCategory
        //instance.getProductCategory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
