...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ProposeAssignmentsApi();
  });
  ...
  describe('ProposeAssignmentsApi', function() {
    describe('proposeAssignmentsApi', function() {
      it('should call proposeAssignmentsApi successfully', function(done) {
        //uncomment below and update the code to test proposeAssignmentsApi
        //instance.proposeAssignmentsApi(function(error) {
