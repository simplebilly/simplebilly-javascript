...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AnlageSApi();
  });
  ...
  describe('AnlageSApi', function() {
    describe('anlageSApi', function() {
      it('should call anlageSApi successfully', function(done) {
        //uncomment below and update the code to test anlageSApi
        //instance.anlageSApi(function(error) {
