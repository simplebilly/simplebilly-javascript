...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GenerateXrechnungApi();
  });
  ...
  describe('GenerateXrechnungApi', function() {
    describe('generateXrechnungApi', function() {
      it('should call generateXrechnungApi successfully', function(done) {
        //uncomment below and update the code to test generateXrechnungApi
        //instance.generateXrechnungApi(function(error) {
