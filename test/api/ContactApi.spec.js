...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ContactApi();
  });
  ...
  describe('ContactApi', function() {
    describe('contactSchema', function() {
      it('should call contactSchema successfully', function(done) {
        //uncomment below and update the code to test contactSchema
        //instance.contactSchema(function(error) {
    ...
    describe('contactTimeline', function() {
      it('should call contactTimeline successfully', function(done) {
        //uncomment below and update the code to test contactTimeline
        //instance.contactTimeline(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('salesVolume', function() {
      it('should call salesVolume successfully', function(done) {
        //uncomment below and update the code to test salesVolume
        //instance.salesVolume(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
