...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.KstApi();
  });
  ...
  describe('KstApi', function() {
    describe('kstApi', function() {
      it('should call kstApi successfully', function(done) {
        //uncomment below and update the code to test kstApi
        //instance.kstApi(function(error) {
