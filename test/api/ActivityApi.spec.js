...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ActivityApi();
  });
  ...
  describe('ActivityApi', function() {
    ...
    describe('updateActivityStatus', function() {
      it('should call updateActivityStatus successfully', function(done) {
        //uncomment below and update the code to test updateActivityStatus
        //instance.updateActivityStatus(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
