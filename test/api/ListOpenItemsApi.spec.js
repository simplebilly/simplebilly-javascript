...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ListOpenItemsApi();
  });
  ...
  describe('ListOpenItemsApi', function() {
    describe('listOpenItemsApi', function() {
      it('should call listOpenItemsApi successfully', function(done) {
        //uncomment below and update the code to test listOpenItemsApi
        //instance.listOpenItemsApi(function(error) {
