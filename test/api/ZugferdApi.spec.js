...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ZugferdApi();
  });
  ...
  describe('ZugferdApi', function() {
    describe('generateZugferdApi', function() {
      it('should call generateZugferdApi successfully', function(done) {
        //uncomment below and update the code to test generateZugferdApi
        //instance.generateZugferdApi(function(error) {
