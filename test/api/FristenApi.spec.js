...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.FristenApi();
  });
  ...
  describe('FristenApi', function() {
    describe('fristenApi', function() {
      it('should call fristenApi successfully', function(done) {
        //uncomment below and update the code to test fristenApi
        //instance.fristenApi(function(error) {
