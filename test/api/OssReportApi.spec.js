...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OssReportApi();
  });
  ...
  describe('OssReportApi', function() {
    describe('ossReportApi', function() {
      it('should call ossReportApi successfully', function(done) {
        //uncomment below and update the code to test ossReportApi
        //instance.ossReportApi(function(error) {
