...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AnlageEksApi();
  });
  ...
  describe('AnlageEksApi', function() {
    describe('eksApi', function() {
      it('should call eksApi successfully', function(done) {
        //uncomment below and update the code to test eksApi
        //instance.eksApi(function(error) {
