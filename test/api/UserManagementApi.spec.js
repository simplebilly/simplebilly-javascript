...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.UserManagementApi();
  });
  ...
  describe('UserManagementApi', function() {
    ...
    describe('updateUserPermissions', function() {
      it('should call updateUserPermissions successfully', function(done) {
        //uncomment below and update the code to test updateUserPermissions
        //instance.updateUserPermissions(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
