...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.InstituteApi();
  });
  ...
  describe('InstituteApi', function() {
    describe('instituteStatusApi', function() {
      it('should call instituteStatusApi successfully', function(done) {
        //uncomment below and update the code to test instituteStatusApi
        //instance.instituteStatusApi(function(error) {
