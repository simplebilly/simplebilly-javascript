...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ShopApi();
  });
  ...
  describe('ShopApi', function() {
    describe('shopEditorSave', function() {
      it('should call shopEditorSave successfully', function(done) {
        //uncomment below and update the code to test shopEditorSave
        //instance.shopEditorSave(function(error) {
