...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GezApi();
  });
  ...
  describe('GezApi', function() {
    describe('gezApi', function() {
      it('should call gezApi successfully', function(done) {
        //uncomment below and update the code to test gezApi
        //instance.gezApi(function(error) {
