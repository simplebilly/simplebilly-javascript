...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PaymentApi();
  });
  ...
  describe('PaymentApi', function() {
    ...
    describe('paymentRestore', function() {
      it('should call paymentRestore successfully', function(done) {
        //uncomment below and update the code to test paymentRestore
        //instance.paymentRestore(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
