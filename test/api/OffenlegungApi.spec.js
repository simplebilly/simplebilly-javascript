...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OffenlegungApi();
  });
  ...
  describe('OffenlegungApi', function() {
    describe('offenlegungApi', function() {
      it('should call offenlegungApi successfully', function(done) {
        //uncomment below and update the code to test offenlegungApi
        //instance.offenlegungApi(function(error) {
