...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.KostenVorschauApi();
  });
  ...
  describe('KostenVorschauApi', function() {
    describe('kostenVorschauApi', function() {
      it('should call kostenVorschauApi successfully', function(done) {
        //uncomment below and update the code to test kostenVorschauApi
        //instance.kostenVorschauApi(function(error) {
