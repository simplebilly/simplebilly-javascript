...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PeppolApi();
  });
  ...
  describe('PeppolApi', function() {
    describe('peppolApi', function() {
      it('should call peppolApi successfully', function(done) {
        //uncomment below and update the code to test peppolApi
        //instance.peppolApi(function(error) {
