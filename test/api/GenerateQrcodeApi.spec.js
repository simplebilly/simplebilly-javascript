...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GenerateQrcodeApi();
  });
  ...
  describe('GenerateQrcodeApi', function() {
    describe('generateQrcodeApi', function() {
      it('should call generateQrcodeApi successfully', function(done) {
        //uncomment below and update the code to test generateQrcodeApi
        //instance.generateQrcodeApi(function(error) {
