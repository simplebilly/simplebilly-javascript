...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GewerbesteuerApi();
  });
  ...
  describe('GewerbesteuerApi', function() {
    describe('gewerbesteuerApi', function() {
      it('should call gewerbesteuerApi successfully', function(done) {
        //uncomment below and update the code to test gewerbesteuerApi
        //instance.gewerbesteuerApi(function(error) {
