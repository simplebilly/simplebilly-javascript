...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AnlageGApi();
  });
  ...
  describe('AnlageGApi', function() {
    describe('anlageGApi', function() {
      it('should call anlageGApi successfully', function(done) {
        //uncomment below and update the code to test anlageGApi
        //instance.anlageGApi(function(error) {
