...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprApiKey();
  });
  ...
  describe('GdprApiKey', function() {
    it('should create an instance of GdprApiKey', function() {
      // uncomment below and update the code to test GdprApiKey
      //var instance = new SimpleBillyApi.GdprApiKey();
      //expect(instance).to.be.a(SimpleBillyApi.GdprApiKey);
    });
