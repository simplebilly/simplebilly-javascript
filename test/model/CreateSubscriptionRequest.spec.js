...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CreateSubscriptionRequest();
  });
  ...
  describe('CreateSubscriptionRequest', function() {
    it('should create an instance of CreateSubscriptionRequest', function() {
      ...
      //var instance = new SimpleBillyApi.CreateSubscriptionRequest();
      //expect(instance).to.be.a(SimpleBillyApi.CreateSubscriptionRequest);
    });
