...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.Job();
  });
  ...
  describe('Job', function() {
    it('should create an instance of Job', function() {
      ...
      //var instance = new SimpleBillyApi.Job();
      //expect(instance).to.be.a(SimpleBillyApi.Job);
    });
    ...
    it('should have the property runAt (base name: "runAt")', function() {
      // uncomment below and update the code to test the property runAt
      //var instance = new SimpleBillyApi.Job();
      //expect(instance).to.be();
    });
