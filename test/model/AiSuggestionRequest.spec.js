...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AiSuggestionRequest();
  });
  ...
  describe('AiSuggestionRequest', function() {
    it('should create an instance of AiSuggestionRequest', function() {
      // uncomment below and update the code to test AiSuggestionRequest
      //var instance = new SimpleBillyApi.AiSuggestionRequest();
      //expect(instance).to.be.a(SimpleBillyApi.AiSuggestionRequest);
    });
