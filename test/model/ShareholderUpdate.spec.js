...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ShareholderUpdate();
  });
  ...
  describe('ShareholderUpdate', function() {
    it('should create an instance of ShareholderUpdate', function() {
      // uncomment below and update the code to test ShareholderUpdate
      //var instance = new SimpleBillyApi.ShareholderUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.ShareholderUpdate);
    });
