...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ProductCategoryCreate();
  });
  ...
  describe('ProductCategoryCreate', function() {
    it('should create an instance of ProductCategoryCreate', function() {
      // uncomment below and update the code to test ProductCategoryCreate
      //var instance = new SimpleBillyApi.ProductCategoryCreate();
      //expect(instance).to.be.a(SimpleBillyApi.ProductCategoryCreate);
    });
