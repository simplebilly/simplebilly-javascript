...
(function(root, factory) {
  ...
  describe('WebhookEventStatus', function() {
    it('should create an instance of WebhookEventStatus', function() {
      // uncomment below and update the code to test WebhookEventStatus
      //var instance = new SimpleBillyApi.WebhookEventStatus();
      //expect(instance).to.be.a(SimpleBillyApi.WebhookEventStatus);
    });
