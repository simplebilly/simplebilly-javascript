...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.EmitEventRequest();
  });
  ...
  describe('EmitEventRequest', function() {
    it('should create an instance of EmitEventRequest', function() {
      // uncomment below and update the code to test EmitEventRequest
      //var instance = new SimpleBillyApi.EmitEventRequest();
      //expect(instance).to.be.a(SimpleBillyApi.EmitEventRequest);
    });
