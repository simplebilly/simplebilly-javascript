...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DhlCredentials();
  });
  ...
  describe('DhlCredentials', function() {
    it('should create an instance of DhlCredentials', function() {
      // uncomment below and update the code to test DhlCredentials
      //var instance = new SimpleBillyApi.DhlCredentials();
      //expect(instance).to.be.a(SimpleBillyApi.DhlCredentials);
    });
