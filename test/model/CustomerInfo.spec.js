...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CustomerInfo();
  });
  ...
  describe('CustomerInfo', function() {
    it('should create an instance of CustomerInfo', function() {
      ...
      //var instance = new SimpleBillyApi.CustomerInfo();
      //expect(instance).to.be.a(SimpleBillyApi.CustomerInfo);
    });

    it('should have the property annualVolume (base name: "annual_volume")', function() {
      // uncomment below and update the code to test the property annualVolume
      //var instance = new SimpleBillyApi.CustomerInfo();
