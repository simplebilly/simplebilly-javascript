...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.UpdateProfileRequest();
  });
  ...
  describe('UpdateProfileRequest', function() {
    it('should create an instance of UpdateProfileRequest', function() {
      ...
      //var instance = new SimpleBillyApi.UpdateProfileRequest();
      //expect(instance).to.be.a(SimpleBillyApi.UpdateProfileRequest);
    });
