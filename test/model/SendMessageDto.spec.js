...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SendMessageDto();
  });
  ...
  describe('SendMessageDto', function() {
    it('should create an instance of SendMessageDto', function() {
      // uncomment below and update the code to test SendMessageDto
      //var instance = new SimpleBillyApi.SendMessageDto();
      //expect(instance).to.be.a(SimpleBillyApi.SendMessageDto);
    });
