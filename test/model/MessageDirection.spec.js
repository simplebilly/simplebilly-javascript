...
(function(root, factory) {
  ...
  describe('MessageDirection', function() {
    it('should create an instance of MessageDirection', function() {
      // uncomment below and update the code to test MessageDirection
      //var instance = new SimpleBillyApi.MessageDirection();
      //expect(instance).to.be.a(SimpleBillyApi.MessageDirection);
    });
