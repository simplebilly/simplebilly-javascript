...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.WebhookSubscription();
  });
  ...
  describe('WebhookSubscription', function() {
    it('should create an instance of WebhookSubscription', function() {
      ...
      //var instance = new SimpleBillyApi.WebhookSubscription();
      //expect(instance).to.be.a(SimpleBillyApi.WebhookSubscription);
    });
