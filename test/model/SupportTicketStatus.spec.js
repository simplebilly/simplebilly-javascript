...
(function(root, factory) {
  ...
  describe('SupportTicketStatus', function() {
    it('should create an instance of SupportTicketStatus', function() {
      // uncomment below and update the code to test SupportTicketStatus
      //var instance = new SimpleBillyApi.SupportTicketStatus();
      //expect(instance).to.be.a(SimpleBillyApi.SupportTicketStatus);
    });
