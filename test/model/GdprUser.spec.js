...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprUser();
  });
  ...
  describe('GdprUser', function() {
    it('should create an instance of GdprUser', function() {
      // uncomment below and update the code to test GdprUser
      //var instance = new SimpleBillyApi.GdprUser();
      //expect(instance).to.be.a(SimpleBillyApi.GdprUser);
    });
