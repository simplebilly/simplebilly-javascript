...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CustomerCommunicationCreate();
  });
  ...
  describe('CustomerCommunicationCreate', function() {
    it('should create an instance of CustomerCommunicationCreate', function() {
      // uncomment below and update the code to test CustomerCommunicationCreate
      //var instance = new SimpleBillyApi.CustomerCommunicationCreate();
      //expect(instance).to.be.a(SimpleBillyApi.CustomerCommunicationCreate);
    });
