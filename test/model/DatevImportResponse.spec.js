...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DatevImportResponse();
  });
  ...
  describe('DatevImportResponse', function() {
    it('should create an instance of DatevImportResponse', function() {
      // uncomment below and update the code to test DatevImportResponse
      //var instance = new SimpleBillyApi.DatevImportResponse();
      //expect(instance).to.be.a(SimpleBillyApi.DatevImportResponse);
    });
