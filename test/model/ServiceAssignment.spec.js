...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ServiceAssignment();
  });
  ...
  describe('ServiceAssignment', function() {
    it('should create an instance of ServiceAssignment', function() {
      // uncomment below and update the code to test ServiceAssignment
      //var instance = new SimpleBillyApi.ServiceAssignment();
      //expect(instance).to.be.a(SimpleBillyApi.ServiceAssignment);
    });
