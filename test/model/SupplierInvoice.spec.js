...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SupplierInvoice();
  });
  ...
  describe('SupplierInvoice', function() {
    it('should create an instance of SupplierInvoice', function() {
      // uncomment below and update the code to test SupplierInvoice
      //var instance = new SimpleBillyApi.SupplierInvoice();
      //expect(instance).to.be.a(SimpleBillyApi.SupplierInvoice);
    });
