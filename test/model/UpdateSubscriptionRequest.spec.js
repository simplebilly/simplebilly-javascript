...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.UpdateSubscriptionRequest();
  });
  ...
  describe('UpdateSubscriptionRequest', function() {
    it('should create an instance of UpdateSubscriptionRequest', function() {
      ...
      //var instance = new SimpleBillyApi.UpdateSubscriptionRequest();
      //expect(instance).to.be.a(SimpleBillyApi.UpdateSubscriptionRequest);
    });
