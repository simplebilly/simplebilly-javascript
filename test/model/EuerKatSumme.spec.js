...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.EuerKatSumme();
  });
  ...
  describe('EuerKatSumme', function() {
    it('should create an instance of EuerKatSumme', function() {
      // uncomment below and update the code to test EuerKatSumme
      //var instance = new SimpleBillyApi.EuerKatSumme();
      //expect(instance).to.be.a(SimpleBillyApi.EuerKatSumme);
    });
