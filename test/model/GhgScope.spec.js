...
(function(root, factory) {
  ...
  describe('GhgScope', function() {
    it('should create an instance of GhgScope', function() {
      // uncomment below and update the code to test GhgScope
      //var instance = new SimpleBillyApi.GhgScope();
      //expect(instance).to.be.a(SimpleBillyApi.GhgScope);
    });
