...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.TaxRateCreate();
  });
  ...
  describe('TaxRateCreate', function() {
    it('should create an instance of TaxRateCreate', function() {
      // uncomment below and update the code to test TaxRateCreate
      //var instance = new SimpleBillyApi.TaxRateCreate();
      //expect(instance).to.be.a(SimpleBillyApi.TaxRateCreate);
    });
