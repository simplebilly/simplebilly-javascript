...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ImportStartResponse();
  });
  ...
  describe('ImportStartResponse', function() {
    it('should create an instance of ImportStartResponse', function() {
      // uncomment below and update the code to test ImportStartResponse
      //var instance = new SimpleBillyApi.ImportStartResponse();
      //expect(instance).to.be.a(SimpleBillyApi.ImportStartResponse);
    });
