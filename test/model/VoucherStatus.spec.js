...
(function(root, factory) {
  ...
  describe('VoucherStatus', function() {
    it('should create an instance of VoucherStatus', function() {
      // uncomment below and update the code to test VoucherStatus
      //var instance = new SimpleBillyApi.VoucherStatus();
      //expect(instance).to.be.a(SimpleBillyApi.VoucherStatus);
    });
