...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.LeadUpdate();
  });
  ...
  describe('LeadUpdate', function() {
    it('should create an instance of LeadUpdate', function() {
      // uncomment below and update the code to test LeadUpdate
      //var instance = new SimpleBillyApi.LeadUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.LeadUpdate);
    });
    ...
    it('should have the property firstContactAt (base name: "firstContactAt")', function() {
      // uncomment below and update the code to test the property firstContactAt
      //var instance = new SimpleBillyApi.LeadUpdate();
      //expect(instance).to.be();
    });
