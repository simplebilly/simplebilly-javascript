...
(function(root, factory) {
  ...
  describe('ReferenceType', function() {
    it('should create an instance of ReferenceType', function() {
      // uncomment below and update the code to test ReferenceType
      //var instance = new SimpleBillyApi.ReferenceType();
      //expect(instance).to.be.a(SimpleBillyApi.ReferenceType);
    });
