...
(function(root, factory) {
  ...
  describe('InvoiceType', function() {
    it('should create an instance of InvoiceType', function() {
      // uncomment below and update the code to test InvoiceType
      //var instance = new SimpleBillyApi.InvoiceType();
      //expect(instance).to.be.a(SimpleBillyApi.InvoiceType);
    });
