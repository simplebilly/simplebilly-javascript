...
(function(root, factory) {
  ...
  describe('EmissionTargetScope', function() {
    it('should create an instance of EmissionTargetScope', function() {
      // uncomment below and update the code to test EmissionTargetScope
      //var instance = new SimpleBillyApi.EmissionTargetScope();
      //expect(instance).to.be.a(SimpleBillyApi.EmissionTargetScope);
    });
