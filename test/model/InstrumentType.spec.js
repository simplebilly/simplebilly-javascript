...
(function(root, factory) {
  ...
  describe('InstrumentType', function() {
    it('should create an instance of InstrumentType', function() {
      // uncomment below and update the code to test InstrumentType
      //var instance = new SimpleBillyApi.InstrumentType();
      //expect(instance).to.be.a(SimpleBillyApi.InstrumentType);
    });
