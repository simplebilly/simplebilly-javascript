...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ExtraPayment();
  });
  ...
  describe('ExtraPayment', function() {
    it('should create an instance of ExtraPayment', function() {
      // uncomment below and update the code to test ExtraPayment
      //var instance = new SimpleBillyApi.ExtraPayment();
      //expect(instance).to.be.a(SimpleBillyApi.ExtraPayment);
    });
