...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GuVItem();
  });
  ...
  describe('GuVItem', function() {
    it('should create an instance of GuVItem', function() {
      // uncomment below and update the code to test GuVItem
      //var instance = new SimpleBillyApi.GuVItem();
      //expect(instance).to.be.a(SimpleBillyApi.GuVItem);
    });
