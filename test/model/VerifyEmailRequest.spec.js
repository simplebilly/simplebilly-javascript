...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.VerifyEmailRequest();
  });
  ...
  describe('VerifyEmailRequest', function() {
    it('should create an instance of VerifyEmailRequest', function() {
      ...
      //var instance = new SimpleBillyApi.VerifyEmailRequest();
      //expect(instance).to.be.a(SimpleBillyApi.VerifyEmailRequest);
    });
