...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SupportTicketUpdate();
  });
  ...
  describe('SupportTicketUpdate', function() {
    it('should create an instance of SupportTicketUpdate', function() {
      // uncomment below and update the code to test SupportTicketUpdate
      //var instance = new SimpleBillyApi.SupportTicketUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.SupportTicketUpdate);
    });
