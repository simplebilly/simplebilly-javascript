...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.KostenEintrag();
  });
  ...
  describe('KostenEintrag', function() {
    it('should create an instance of KostenEintrag', function() {
      // uncomment below and update the code to test KostenEintrag
      //var instance = new SimpleBillyApi.KostenEintrag();
      //expect(instance).to.be.a(SimpleBillyApi.KostenEintrag);
    });
