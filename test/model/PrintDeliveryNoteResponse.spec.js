...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PrintDeliveryNoteResponse();
  });
  ...
  describe('PrintDeliveryNoteResponse', function() {
    it('should create an instance of PrintDeliveryNoteResponse', function() {
      // uncomment below and update the code to test PrintDeliveryNoteResponse
      //var instance = new SimpleBillyApi.PrintDeliveryNoteResponse();
      //expect(instance).to.be.a(SimpleBillyApi.PrintDeliveryNoteResponse);
    });
