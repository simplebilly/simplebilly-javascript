...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.BomCreate();
  });
  ...
  describe('BomCreate', function() {
    it('should create an instance of BomCreate', function() {
      // uncomment below and update the code to test BomCreate
      //var instance = new SimpleBillyApi.BomCreate();
      //expect(instance).to.be.a(SimpleBillyApi.BomCreate);
    });
