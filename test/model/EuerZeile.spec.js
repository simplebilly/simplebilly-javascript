...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.EuerZeile();
  });
  ...
  describe('EuerZeile', function() {
    it('should create an instance of EuerZeile', function() {
      // uncomment below and update the code to test EuerZeile
      //var instance = new SimpleBillyApi.EuerZeile();
      //expect(instance).to.be.a(SimpleBillyApi.EuerZeile);
    });
