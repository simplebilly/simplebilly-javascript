...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.Declaration();
  });
  ...
  describe('Declaration', function() {
    it('should create an instance of Declaration', function() {
      // uncomment below and update the code to test Declaration
      //var instance = new SimpleBillyApi.Declaration();
      //expect(instance).to.be.a(SimpleBillyApi.Declaration);
    });
