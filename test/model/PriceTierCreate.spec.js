...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PriceTierCreate();
  });
  ...
  describe('PriceTierCreate', function() {
    it('should create an instance of PriceTierCreate', function() {
      // uncomment below and update the code to test PriceTierCreate
      //var instance = new SimpleBillyApi.PriceTierCreate();
      //expect(instance).to.be.a(SimpleBillyApi.PriceTierCreate);
    });
