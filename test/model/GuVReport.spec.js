...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GuVReport();
  });
  ...
  describe('GuVReport', function() {
    it('should create an instance of GuVReport', function() {
      // uncomment below and update the code to test GuVReport
      //var instance = new SimpleBillyApi.GuVReport();
      //expect(instance).to.be.a(SimpleBillyApi.GuVReport);
    });
