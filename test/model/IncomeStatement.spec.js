...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.IncomeStatement();
  });
  ...
  describe('IncomeStatement', function() {
    it('should create an instance of IncomeStatement', function() {
      ...
      //var instance = new SimpleBillyApi.IncomeStatement();
      //expect(instance).to.be.a(SimpleBillyApi.IncomeStatement);
    });

    it('should have the property expenseItems (base name: "expense_items")', function() {
      // uncomment below and update the code to test the property expenseItems
      //var instance = new SimpleBillyApi.IncomeStatement();
    ...
    it('should have the property revenueItems (base name: "revenue_items")', function() {
      // uncomment below and update the code to test the property revenueItems
      //var instance = new SimpleBillyApi.IncomeStatement();
      //expect(instance).to.be();
    });
