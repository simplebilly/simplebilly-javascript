...
(function(root, factory) {
  ...
  describe('MovementType', function() {
    it('should create an instance of MovementType', function() {
      // uncomment below and update the code to test MovementType
      //var instance = new SimpleBillyApi.MovementType();
      //expect(instance).to.be.a(SimpleBillyApi.MovementType);
    });
