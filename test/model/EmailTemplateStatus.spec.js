...
(function(root, factory) {
  ...
  describe('EmailTemplateStatus', function() {
    it('should create an instance of EmailTemplateStatus', function() {
      // uncomment below and update the code to test EmailTemplateStatus
      //var instance = new SimpleBillyApi.EmailTemplateStatus();
      //expect(instance).to.be.a(SimpleBillyApi.EmailTemplateStatus);
    });
