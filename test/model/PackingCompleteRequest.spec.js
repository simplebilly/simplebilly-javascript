...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PackingCompleteRequest();
  });
  ...
  describe('PackingCompleteRequest', function() {
    it('should create an instance of PackingCompleteRequest', function() {
      // uncomment below and update the code to test PackingCompleteRequest
      //var instance = new SimpleBillyApi.PackingCompleteRequest();
      //expect(instance).to.be.a(SimpleBillyApi.PackingCompleteRequest);
    });
