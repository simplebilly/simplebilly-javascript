...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprBillingInfo();
  });
  ...
  describe('GdprBillingInfo', function() {
    it('should create an instance of GdprBillingInfo', function() {
      // uncomment below and update the code to test GdprBillingInfo
      //var instance = new SimpleBillyApi.GdprBillingInfo();
      //expect(instance).to.be.a(SimpleBillyApi.GdprBillingInfo);
    });
