...
(function(root, factory) {
  ...
  describe('LegalDocType', function() {
    it('should create an instance of LegalDocType', function() {
      // uncomment below and update the code to test LegalDocType
      //var instance = new SimpleBillyApi.LegalDocType();
      //expect(instance).to.be.a(SimpleBillyApi.LegalDocType);
    });
