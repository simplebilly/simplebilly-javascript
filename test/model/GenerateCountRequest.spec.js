...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GenerateCountRequest();
  });
  ...
  describe('GenerateCountRequest', function() {
    it('should create an instance of GenerateCountRequest', function() {
      // uncomment below and update the code to test GenerateCountRequest
      //var instance = new SimpleBillyApi.GenerateCountRequest();
      //expect(instance).to.be.a(SimpleBillyApi.GenerateCountRequest);
    });
