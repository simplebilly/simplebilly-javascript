...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SyncLog();
  });
  ...
  describe('SyncLog', function() {
    it('should create an instance of SyncLog', function() {
      // uncomment below and update the code to test SyncLog
      //var instance = new SimpleBillyApi.SyncLog();
      //expect(instance).to.be.a(SimpleBillyApi.SyncLog);
    });
    ...
    it('should have the property itemsFailed (base name: "items_failed")', function() {
      // uncomment below and update the code to test the property itemsFailed
      //var instance = new SimpleBillyApi.SyncLog();
      //expect(instance).to.be();
    });

    it('should have the property itemsSynced (base name: "items_synced")', function() {
