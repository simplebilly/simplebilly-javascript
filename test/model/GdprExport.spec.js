...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprExport();
  });
  ...
  describe('GdprExport', function() {
    it('should create an instance of GdprExport', function() {
      // uncomment below and update the code to test GdprExport
      //var instance = new SimpleBillyApi.GdprExport();
      //expect(instance).to.be.a(SimpleBillyApi.GdprExport);
    });
