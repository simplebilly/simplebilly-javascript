...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CouponValidation();
  });
  ...
  describe('CouponValidation', function() {
    it('should create an instance of CouponValidation', function() {
      // uncomment below and update the code to test CouponValidation
      //var instance = new SimpleBillyApi.CouponValidation();
      //expect(instance).to.be.a(SimpleBillyApi.CouponValidation);
    });
    ...
    it('should have the property maxDiscountAmount (base name: "max_discount_amount")', function() {
