...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AbsenceUpdate();
  });
  ...
  describe('AbsenceUpdate', function() {
    it('should create an instance of AbsenceUpdate', function() {
      // uncomment below and update the code to test AbsenceUpdate
      //var instance = new SimpleBillyApi.AbsenceUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.AbsenceUpdate);
    });

    it('should have the property absenceType (base name: "absenceType")', function() {
      // uncomment below and update the code to test the property absenceType
      //var instance = new SimpleBillyApi.AbsenceUpdate();
