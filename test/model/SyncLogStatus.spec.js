...
(function(root, factory) {
  ...
  describe('SyncLogStatus', function() {
    it('should create an instance of SyncLogStatus', function() {
      // uncomment below and update the code to test SyncLogStatus
      //var instance = new SimpleBillyApi.SyncLogStatus();
      //expect(instance).to.be.a(SimpleBillyApi.SyncLogStatus);
    });
