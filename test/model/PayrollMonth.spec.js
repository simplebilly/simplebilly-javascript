...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PayrollMonth();
  });
  ...
  describe('PayrollMonth', function() {
    it('should create an instance of PayrollMonth', function() {
      // uncomment below and update the code to test PayrollMonth
      //var instance = new SimpleBillyApi.PayrollMonth();
      //expect(instance).to.be.a(SimpleBillyApi.PayrollMonth);
    });

    it('should have the property gross (base name: "gross")', function() {
      // uncomment below and update the code to test the property gross
      //var instance = new SimpleBillyApi.PayrollMonth();
