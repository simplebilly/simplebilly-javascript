...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PlausibilityReport();
  });
  ...
  describe('PlausibilityReport', function() {
    it('should create an instance of PlausibilityReport', function() {
      // uncomment below and update the code to test PlausibilityReport
      //var instance = new SimpleBillyApi.PlausibilityReport();
      //expect(instance).to.be.a(SimpleBillyApi.PlausibilityReport);
    });
