...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PeppolResponse();
  });
  ...
  describe('PeppolResponse', function() {
    it('should create an instance of PeppolResponse', function() {
      // uncomment below and update the code to test PeppolResponse
      //var instance = new SimpleBillyApi.PeppolResponse();
      //expect(instance).to.be.a(SimpleBillyApi.PeppolResponse);
    });
