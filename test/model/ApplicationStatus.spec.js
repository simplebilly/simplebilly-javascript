...
(function(root, factory) {
  ...
  describe('ApplicationStatus', function() {
    it('should create an instance of ApplicationStatus', function() {
      // uncomment below and update the code to test ApplicationStatus
      //var instance = new SimpleBillyApi.ApplicationStatus();
      //expect(instance).to.be.a(SimpleBillyApi.ApplicationStatus);
    });
