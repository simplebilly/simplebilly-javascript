...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.EmployeeCreate();
  });
  ...
  describe('EmployeeCreate', function() {
    it('should create an instance of EmployeeCreate', function() {
      // uncomment below and update the code to test EmployeeCreate
      //var instance = new SimpleBillyApi.EmployeeCreate();
      //expect(instance).to.be.a(SimpleBillyApi.EmployeeCreate);
    });
