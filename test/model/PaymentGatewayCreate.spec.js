...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PaymentGatewayCreate();
  });
  ...
  describe('PaymentGatewayCreate', function() {
    it('should create an instance of PaymentGatewayCreate', function() {
      // uncomment below and update the code to test PaymentGatewayCreate
      //var instance = new SimpleBillyApi.PaymentGatewayCreate();
      //expect(instance).to.be.a(SimpleBillyApi.PaymentGatewayCreate);
    });
