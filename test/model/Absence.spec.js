...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.Absence();
  });
  ...
  describe('Absence', function() {
    it('should create an instance of Absence', function() {
      // uncomment below and update the code to test Absence
      //var instance = new SimpleBillyApi.Absence();
      //expect(instance).to.be.a(SimpleBillyApi.Absence);
    });
