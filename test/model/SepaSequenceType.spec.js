...
(function(root, factory) {
  ...
  describe('SepaSequenceType', function() {
    it('should create an instance of SepaSequenceType', function() {
      // uncomment below and update the code to test SepaSequenceType
      //var instance = new SimpleBillyApi.SepaSequenceType();
      //expect(instance).to.be.a(SimpleBillyApi.SepaSequenceType);
    });
