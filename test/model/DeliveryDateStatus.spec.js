...
(function(root, factory) {
  ...
  describe('DeliveryDateStatus', function() {
    it('should create an instance of DeliveryDateStatus', function() {
      // uncomment below and update the code to test DeliveryDateStatus
      //var instance = new SimpleBillyApi.DeliveryDateStatus();
      //expect(instance).to.be.a(SimpleBillyApi.DeliveryDateStatus);
    });
