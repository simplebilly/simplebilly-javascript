...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.StockAdjustment();
  });
  ...
  describe('StockAdjustment', function() {
    it('should create an instance of StockAdjustment', function() {
      // uncomment below and update the code to test StockAdjustment
      //var instance = new SimpleBillyApi.StockAdjustment();
      //expect(instance).to.be.a(SimpleBillyApi.StockAdjustment);
    });
    ...
    it('should have the property binLocation (base name: "binLocation")', function() {
      // uncomment below and update the code to test the property binLocation
      //var instance = new SimpleBillyApi.StockAdjustment();
      //expect(instance).to.be();
    });
