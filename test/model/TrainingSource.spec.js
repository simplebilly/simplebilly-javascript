...
(function(root, factory) {
  ...
  describe('TrainingSource', function() {
    it('should create an instance of TrainingSource', function() {
      // uncomment below and update the code to test TrainingSource
      //var instance = new SimpleBillyApi.TrainingSource();
      //expect(instance).to.be.a(SimpleBillyApi.TrainingSource);
    });
