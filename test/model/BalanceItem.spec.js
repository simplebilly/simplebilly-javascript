...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.BalanceItem();
  });
  ...
  describe('BalanceItem', function() {
    it('should create an instance of BalanceItem', function() {
      // uncomment below and update the code to test BalanceItem
      //var instance = new SimpleBillyApi.BalanceItem();
      //expect(instance).to.be.a(SimpleBillyApi.BalanceItem);
    });
