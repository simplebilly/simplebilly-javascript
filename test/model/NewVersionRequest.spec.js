...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.NewVersionRequest();
  });
  ...
  describe('NewVersionRequest', function() {
    it('should create an instance of NewVersionRequest', function() {
      // uncomment below and update the code to test NewVersionRequest
      //var instance = new SimpleBillyApi.NewVersionRequest();
      //expect(instance).to.be.a(SimpleBillyApi.NewVersionRequest);
    });
