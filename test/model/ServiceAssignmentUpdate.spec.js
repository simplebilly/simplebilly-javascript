...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ServiceAssignmentUpdate();
  });
  ...
  describe('ServiceAssignmentUpdate', function() {
    it('should create an instance of ServiceAssignmentUpdate', function() {
      // uncomment below and update the code to test ServiceAssignmentUpdate
      //var instance = new SimpleBillyApi.ServiceAssignmentUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.ServiceAssignmentUpdate);
    });
