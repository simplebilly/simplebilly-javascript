...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SupportChannel();
  });
  ...
  describe('SupportChannel', function() {
    it('should create an instance of SupportChannel', function() {
      // uncomment below and update the code to test SupportChannel
      //var instance = new SimpleBillyApi.SupportChannel();
      //expect(instance).to.be.a(SimpleBillyApi.SupportChannel);
    });
