...
(function(root, factory) {
  ...
  describe('AbsenceType', function() {
    it('should create an instance of AbsenceType', function() {
      // uncomment below and update the code to test AbsenceType
      //var instance = new SimpleBillyApi.AbsenceType();
      //expect(instance).to.be.a(SimpleBillyApi.AbsenceType);
    });
