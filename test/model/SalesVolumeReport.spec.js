...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SalesVolumeReport();
  });
  ...
  describe('SalesVolumeReport', function() {
    it('should create an instance of SalesVolumeReport', function() {
      // uncomment below and update the code to test SalesVolumeReport
      //var instance = new SimpleBillyApi.SalesVolumeReport();
      //expect(instance).to.be.a(SimpleBillyApi.SalesVolumeReport);
    });
