...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PrintLabelResponse();
  });
  ...
  describe('PrintLabelResponse', function() {
    it('should create an instance of PrintLabelResponse', function() {
      // uncomment below and update the code to test PrintLabelResponse
      //var instance = new SimpleBillyApi.PrintLabelResponse();
      //expect(instance).to.be.a(SimpleBillyApi.PrintLabelResponse);
    });
