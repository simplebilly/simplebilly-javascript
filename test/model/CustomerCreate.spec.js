...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CustomerCreate();
  });
  ...
  describe('CustomerCreate', function() {
    it('should create an instance of CustomerCreate', function() {
      // uncomment below and update the code to test CustomerCreate
      //var instance = new SimpleBillyApi.CustomerCreate();
      //expect(instance).to.be.a(SimpleBillyApi.CustomerCreate);
    });
    ...
    it('should have the property externalOrderNumber (base name: "externalOrderNumber")', function() {
      // uncomment below and update the code to test the property externalOrderNumber
      //var instance = new SimpleBillyApi.CustomerCreate();
      //expect(instance).to.be();
    });
