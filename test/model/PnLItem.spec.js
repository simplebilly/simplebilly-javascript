...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PnLItem();
  });
  ...
  describe('PnLItem', function() {
    it('should create an instance of PnLItem', function() {
      // uncomment below and update the code to test PnLItem
      //var instance = new SimpleBillyApi.PnLItem();
      //expect(instance).to.be.a(SimpleBillyApi.PnLItem);
    });
