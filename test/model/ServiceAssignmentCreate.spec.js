...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ServiceAssignmentCreate();
  });
  ...
  describe('ServiceAssignmentCreate', function() {
    it('should create an instance of ServiceAssignmentCreate', function() {
      // uncomment below and update the code to test ServiceAssignmentCreate
      //var instance = new SimpleBillyApi.ServiceAssignmentCreate();
      //expect(instance).to.be.a(SimpleBillyApi.ServiceAssignmentCreate);
    });
    ...
    it('should have the property scheduledDate (base name: "scheduledDate")', function() {
      // uncomment below and update the code to test the property scheduledDate
      //var instance = new SimpleBillyApi.ServiceAssignmentCreate();
      //expect(instance).to.be();
    });
