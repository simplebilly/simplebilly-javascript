...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprTenant();
  });
  ...
  describe('GdprTenant', function() {
    it('should create an instance of GdprTenant', function() {
      // uncomment below and update the code to test GdprTenant
      //var instance = new SimpleBillyApi.GdprTenant();
      //expect(instance).to.be.a(SimpleBillyApi.GdprTenant);
    });
