...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SubscriptionOverview();
  });
  ...
  describe('SubscriptionOverview', function() {
    it('should create an instance of SubscriptionOverview', function() {
      // uncomment below and update the code to test SubscriptionOverview
      //var instance = new SimpleBillyApi.SubscriptionOverview();
      //expect(instance).to.be.a(SimpleBillyApi.SubscriptionOverview);
    });
