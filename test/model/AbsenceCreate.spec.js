...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AbsenceCreate();
  });
  ...
  describe('AbsenceCreate', function() {
    it('should create an instance of AbsenceCreate', function() {
      // uncomment below and update the code to test AbsenceCreate
      //var instance = new SimpleBillyApi.AbsenceCreate();
      //expect(instance).to.be.a(SimpleBillyApi.AbsenceCreate);
    });
