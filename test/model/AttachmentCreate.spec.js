...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AttachmentCreate();
  });
  ...
  describe('AttachmentCreate', function() {
    it('should create an instance of AttachmentCreate', function() {
      // uncomment below and update the code to test AttachmentCreate
      //var instance = new SimpleBillyApi.AttachmentCreate();
      //expect(instance).to.be.a(SimpleBillyApi.AttachmentCreate);
    });
