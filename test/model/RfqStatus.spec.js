...
(function(root, factory) {
  ...
  describe('RfqStatus', function() {
    it('should create an instance of RfqStatus', function() {
      // uncomment below and update the code to test RfqStatus
      //var instance = new SimpleBillyApi.RfqStatus();
      //expect(instance).to.be.a(SimpleBillyApi.RfqStatus);
    });
