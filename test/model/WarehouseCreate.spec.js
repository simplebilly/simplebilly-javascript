...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.WarehouseCreate();
  });
  ...
  describe('WarehouseCreate', function() {
    it('should create an instance of WarehouseCreate', function() {
      // uncomment below and update the code to test WarehouseCreate
      //var instance = new SimpleBillyApi.WarehouseCreate();
      //expect(instance).to.be.a(SimpleBillyApi.WarehouseCreate);
    });
