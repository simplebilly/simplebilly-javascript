...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ServiceJobCreate();
  });
  ...
  describe('ServiceJobCreate', function() {
    it('should create an instance of ServiceJobCreate', function() {
      // uncomment below and update the code to test ServiceJobCreate
      //var instance = new SimpleBillyApi.ServiceJobCreate();
      //expect(instance).to.be.a(SimpleBillyApi.ServiceJobCreate);
    });
