...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GatewayOAuthCallbackRequest();
  });
  ...
  describe('GatewayOAuthCallbackRequest', function() {
    it('should create an instance of GatewayOAuthCallbackRequest', function() {
      // uncomment below and update the code to test GatewayOAuthCallbackRequest
      //var instance = new SimpleBillyApi.GatewayOAuthCallbackRequest();
      //expect(instance).to.be.a(SimpleBillyApi.GatewayOAuthCallbackRequest);
    });
