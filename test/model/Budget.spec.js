...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.Budget();
  });
  ...
  describe('Budget', function() {
    it('should create an instance of Budget', function() {
      ...
      //var instance = new SimpleBillyApi.Budget();
      //expect(instance).to.be.a(SimpleBillyApi.Budget);
    });
    ...
    it('should have the property monthlyGoal (base name: "monthlyGoal")', function() {
