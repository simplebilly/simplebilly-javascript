...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CouponUpdate();
  });
  ...
  describe('CouponUpdate', function() {
    it('should create an instance of CouponUpdate', function() {
      // uncomment below and update the code to test CouponUpdate
      //var instance = new SimpleBillyApi.CouponUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.CouponUpdate);
    });
