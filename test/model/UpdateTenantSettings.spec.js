...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.UpdateTenantSettings();
  });
  ...
  describe('UpdateTenantSettings', function() {
    it('should create an instance of UpdateTenantSettings', function() {
      // uncomment below and update the code to test UpdateTenantSettings
      //var instance = new SimpleBillyApi.UpdateTenantSettings();
      //expect(instance).to.be.a(SimpleBillyApi.UpdateTenantSettings);
    });
