...
(function(root, factory) {
  ...
  describe('VoucherType', function() {
    it('should create an instance of VoucherType', function() {
      // uncomment below and update the code to test VoucherType
      //var instance = new SimpleBillyApi.VoucherType();
      //expect(instance).to.be.a(SimpleBillyApi.VoucherType);
    });
