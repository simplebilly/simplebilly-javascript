...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.StilleReport();
  });
  ...
  describe('StilleReport', function() {
    it('should create an instance of StilleReport', function() {
      // uncomment below and update the code to test StilleReport
      //var instance = new SimpleBillyApi.StilleReport();
      //expect(instance).to.be.a(SimpleBillyApi.StilleReport);
    });
