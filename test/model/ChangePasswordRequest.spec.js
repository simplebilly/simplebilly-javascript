...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ChangePasswordRequest();
  });
  ...
  describe('ChangePasswordRequest', function() {
    it('should create an instance of ChangePasswordRequest', function() {
      ...
      //var instance = new SimpleBillyApi.ChangePasswordRequest();
      //expect(instance).to.be.a(SimpleBillyApi.ChangePasswordRequest);
    });
