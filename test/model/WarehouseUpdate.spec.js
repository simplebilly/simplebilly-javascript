...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.WarehouseUpdate();
  });
  ...
  describe('WarehouseUpdate', function() {
    it('should create an instance of WarehouseUpdate', function() {
      // uncomment below and update the code to test WarehouseUpdate
      //var instance = new SimpleBillyApi.WarehouseUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.WarehouseUpdate);
    });
    ...
    it('should have the property binLocations (base name: "binLocations")', function() {
      // uncomment below and update the code to test the property binLocations
      //var instance = new SimpleBillyApi.WarehouseUpdate();
      //expect(instance).to.be();
    });
