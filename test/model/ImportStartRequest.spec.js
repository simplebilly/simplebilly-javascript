...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ImportStartRequest();
  });
  ...
  describe('ImportStartRequest', function() {
    it('should create an instance of ImportStartRequest', function() {
      // uncomment below and update the code to test ImportStartRequest
      //var instance = new SimpleBillyApi.ImportStartRequest();
      //expect(instance).to.be.a(SimpleBillyApi.ImportStartRequest);
    });
