...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprUsageEvent();
  });
  ...
  describe('GdprUsageEvent', function() {
    it('should create an instance of GdprUsageEvent', function() {
      // uncomment below and update the code to test GdprUsageEvent
      //var instance = new SimpleBillyApi.GdprUsageEvent();
      //expect(instance).to.be.a(SimpleBillyApi.GdprUsageEvent);
    });
