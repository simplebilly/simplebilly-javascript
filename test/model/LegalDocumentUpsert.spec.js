...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.LegalDocumentUpsert();
  });
  ...
  describe('LegalDocumentUpsert', function() {
    it('should create an instance of LegalDocumentUpsert', function() {
      // uncomment below and update the code to test LegalDocumentUpsert
      //var instance = new SimpleBillyApi.LegalDocumentUpsert();
      //expect(instance).to.be.a(SimpleBillyApi.LegalDocumentUpsert);
    });
