...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PublicPosting();
  });
  ...
  describe('PublicPosting', function() {
    it('should create an instance of PublicPosting', function() {
      // uncomment below and update the code to test PublicPosting
      //var instance = new SimpleBillyApi.PublicPosting();
      //expect(instance).to.be.a(SimpleBillyApi.PublicPosting);
    });
