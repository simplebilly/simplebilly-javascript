...
(function(root, factory) {
  ...
  describe('PayrollRunStatus', function() {
    it('should create an instance of PayrollRunStatus', function() {
      // uncomment below and update the code to test PayrollRunStatus
      //var instance = new SimpleBillyApi.PayrollRunStatus();
      //expect(instance).to.be.a(SimpleBillyApi.PayrollRunStatus);
    });
