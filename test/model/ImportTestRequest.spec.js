...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ImportTestRequest();
  });
  ...
  describe('ImportTestRequest', function() {
    it('should create an instance of ImportTestRequest', function() {
      // uncomment below and update the code to test ImportTestRequest
      //var instance = new SimpleBillyApi.ImportTestRequest();
      //expect(instance).to.be.a(SimpleBillyApi.ImportTestRequest);
    });
