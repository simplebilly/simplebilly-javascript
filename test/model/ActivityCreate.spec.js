...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ActivityCreate();
  });
  ...
  describe('ActivityCreate', function() {
    it('should create an instance of ActivityCreate', function() {
      // uncomment below and update the code to test ActivityCreate
      //var instance = new SimpleBillyApi.ActivityCreate();
      //expect(instance).to.be.a(SimpleBillyApi.ActivityCreate);
    });
