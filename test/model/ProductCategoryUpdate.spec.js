...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ProductCategoryUpdate();
  });
  ...
  describe('ProductCategoryUpdate', function() {
    it('should create an instance of ProductCategoryUpdate', function() {
      // uncomment below and update the code to test ProductCategoryUpdate
      //var instance = new SimpleBillyApi.ProductCategoryUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.ProductCategoryUpdate);
    });
