...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.EmailTemplateCreate();
  });
  ...
  describe('EmailTemplateCreate', function() {
    it('should create an instance of EmailTemplateCreate', function() {
      // uncomment below and update the code to test EmailTemplateCreate
      //var instance = new SimpleBillyApi.EmailTemplateCreate();
      //expect(instance).to.be.a(SimpleBillyApi.EmailTemplateCreate);
    });
