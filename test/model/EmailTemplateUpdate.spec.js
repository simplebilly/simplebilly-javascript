...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.EmailTemplateUpdate();
  });
  ...
  describe('EmailTemplateUpdate', function() {
    it('should create an instance of EmailTemplateUpdate', function() {
      // uncomment below and update the code to test EmailTemplateUpdate
      //var instance = new SimpleBillyApi.EmailTemplateUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.EmailTemplateUpdate);
    });
