...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PayrollPayPayload();
  });
  ...
  describe('PayrollPayPayload', function() {
    it('should create an instance of PayrollPayPayload', function() {
      // uncomment below and update the code to test PayrollPayPayload
      //var instance = new SimpleBillyApi.PayrollPayPayload();
      //expect(instance).to.be.a(SimpleBillyApi.PayrollPayPayload);
    });
