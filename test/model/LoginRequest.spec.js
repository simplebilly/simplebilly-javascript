...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.LoginRequest();
  });
  ...
  describe('LoginRequest', function() {
    it('should create an instance of LoginRequest', function() {
      ...
      //var instance = new SimpleBillyApi.LoginRequest();
      //expect(instance).to.be.a(SimpleBillyApi.LoginRequest);
    });
    ...
    it('should have the property totpCode (base name: "totp_code")', function() {
      // uncomment below and update the code to test the property totpCode
      //var instance = new SimpleBillyApi.LoginRequest();
      //expect(instance).to.be();
    });
