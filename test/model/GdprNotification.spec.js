...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprNotification();
  });
  ...
  describe('GdprNotification', function() {
    it('should create an instance of GdprNotification', function() {
      // uncomment below and update the code to test GdprNotification
      //var instance = new SimpleBillyApi.GdprNotification();
      //expect(instance).to.be.a(SimpleBillyApi.GdprNotification);
    });
