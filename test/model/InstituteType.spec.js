...
(function(root, factory) {
  ...
  describe('InstituteType', function() {
    it('should create an instance of InstituteType', function() {
      // uncomment below and update the code to test InstituteType
      //var instance = new SimpleBillyApi.InstituteType();
      //expect(instance).to.be.a(SimpleBillyApi.InstituteType);
    });
