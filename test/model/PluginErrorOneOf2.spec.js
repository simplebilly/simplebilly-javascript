...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PluginErrorOneOf2();
  });
  ...
  describe('PluginErrorOneOf2', function() {
    it('should create an instance of PluginErrorOneOf2', function() {
      // uncomment below and update the code to test PluginErrorOneOf2
      //var instance = new SimpleBillyApi.PluginErrorOneOf2();
      //expect(instance).to.be.a(SimpleBillyApi.PluginErrorOneOf2);
    });
