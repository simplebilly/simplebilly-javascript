...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.Shareholder();
  });
  ...
  describe('Shareholder', function() {
    it('should create an instance of Shareholder', function() {
      // uncomment below and update the code to test Shareholder
      //var instance = new SimpleBillyApi.Shareholder();
      //expect(instance).to.be.a(SimpleBillyApi.Shareholder);
    });
