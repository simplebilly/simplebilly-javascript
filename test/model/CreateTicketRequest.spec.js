...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CreateTicketRequest();
  });
  ...
  describe('CreateTicketRequest', function() {
    it('should create an instance of CreateTicketRequest', function() {
      ...
      //var instance = new SimpleBillyApi.CreateTicketRequest();
      //expect(instance).to.be.a(SimpleBillyApi.CreateTicketRequest);
    });
    ...
    it('should have the property orderRef (base name: "order_ref")', function() {
