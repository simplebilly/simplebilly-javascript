...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.UpdateSyncDirectionRequest();
  });
  ...
  describe('UpdateSyncDirectionRequest', function() {
    it('should create an instance of UpdateSyncDirectionRequest', function() {
      // uncomment below and update the code to test UpdateSyncDirectionRequest
      //var instance = new SimpleBillyApi.UpdateSyncDirectionRequest();
      //expect(instance).to.be.a(SimpleBillyApi.UpdateSyncDirectionRequest);
    });
