...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DeliveryDateCreate();
  });
  ...
  describe('DeliveryDateCreate', function() {
    it('should create an instance of DeliveryDateCreate', function() {
      // uncomment below and update the code to test DeliveryDateCreate
      //var instance = new SimpleBillyApi.DeliveryDateCreate();
      //expect(instance).to.be.a(SimpleBillyApi.DeliveryDateCreate);
    });
    ...
    it('should have the property fulfilledDate (base name: "fulfilledDate")', function() {
      // uncomment below and update the code to test the property fulfilledDate
      //var instance = new SimpleBillyApi.DeliveryDateCreate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property promisedDate (base name: "promisedDate")', function() {
      // uncomment below and update the code to test the property promisedDate
      //var instance = new SimpleBillyApi.DeliveryDateCreate();
      //expect(instance).to.be();
    });
