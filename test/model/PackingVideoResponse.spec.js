...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PackingVideoResponse();
  });
  ...
  describe('PackingVideoResponse', function() {
    it('should create an instance of PackingVideoResponse', function() {
      // uncomment below and update the code to test PackingVideoResponse
      //var instance = new SimpleBillyApi.PackingVideoResponse();
      //expect(instance).to.be.a(SimpleBillyApi.PackingVideoResponse);
    });
