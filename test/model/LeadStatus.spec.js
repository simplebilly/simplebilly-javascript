...
(function(root, factory) {
  ...
  describe('LeadStatus', function() {
    it('should create an instance of LeadStatus', function() {
      // uncomment below and update the code to test LeadStatus
      //var instance = new SimpleBillyApi.LeadStatus();
      //expect(instance).to.be.a(SimpleBillyApi.LeadStatus);
    });
