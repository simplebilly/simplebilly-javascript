...
(function(root, factory) {
  ...
  describe('AbsenceStatus', function() {
    it('should create an instance of AbsenceStatus', function() {
      // uncomment below and update the code to test AbsenceStatus
      //var instance = new SimpleBillyApi.AbsenceStatus();
      //expect(instance).to.be.a(SimpleBillyApi.AbsenceStatus);
    });
