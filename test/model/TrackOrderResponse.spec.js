...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.TrackOrderResponse();
  });
  ...
  describe('TrackOrderResponse', function() {
    it('should create an instance of TrackOrderResponse', function() {
      // uncomment below and update the code to test TrackOrderResponse
      //var instance = new SimpleBillyApi.TrackOrderResponse();
      //expect(instance).to.be.a(SimpleBillyApi.TrackOrderResponse);
    });
