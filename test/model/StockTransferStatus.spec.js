...
(function(root, factory) {
  ...
  describe('StockTransferStatus', function() {
    it('should create an instance of StockTransferStatus', function() {
      // uncomment below and update the code to test StockTransferStatus
      //var instance = new SimpleBillyApi.StockTransferStatus();
      //expect(instance).to.be.a(SimpleBillyApi.StockTransferStatus);
    });
