...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OAuthCallbackRequest();
  });
  ...
  describe('OAuthCallbackRequest', function() {
    it('should create an instance of OAuthCallbackRequest', function() {
      // uncomment below and update the code to test OAuthCallbackRequest
      //var instance = new SimpleBillyApi.OAuthCallbackRequest();
      //expect(instance).to.be.a(SimpleBillyApi.OAuthCallbackRequest);
    });
