...
(function(root, factory) {
  ...
  describe('GatewayType', function() {
    it('should create an instance of GatewayType', function() {
      // uncomment below and update the code to test GatewayType
      //var instance = new SimpleBillyApi.GatewayType();
      //expect(instance).to.be.a(SimpleBillyApi.GatewayType);
    });
