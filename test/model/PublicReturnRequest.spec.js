...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PublicReturnRequest();
  });
  ...
  describe('PublicReturnRequest', function() {
    it('should create an instance of PublicReturnRequest', function() {
      // uncomment below and update the code to test PublicReturnRequest
      //var instance = new SimpleBillyApi.PublicReturnRequest();
      //expect(instance).to.be.a(SimpleBillyApi.PublicReturnRequest);
    });
