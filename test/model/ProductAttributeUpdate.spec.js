...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ProductAttributeUpdate();
  });
  ...
  describe('ProductAttributeUpdate', function() {
    it('should create an instance of ProductAttributeUpdate', function() {
      // uncomment below and update the code to test ProductAttributeUpdate
      //var instance = new SimpleBillyApi.ProductAttributeUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.ProductAttributeUpdate);
    });
