...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PurchaseOrderCreate();
  });
  ...
  describe('PurchaseOrderCreate', function() {
    it('should create an instance of PurchaseOrderCreate', function() {
      // uncomment below and update the code to test PurchaseOrderCreate
      //var instance = new SimpleBillyApi.PurchaseOrderCreate();
      //expect(instance).to.be.a(SimpleBillyApi.PurchaseOrderCreate);
    });
