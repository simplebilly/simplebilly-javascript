...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CustomerCommunication();
  });
  ...
  describe('CustomerCommunication', function() {
    it('should create an instance of CustomerCommunication', function() {
      // uncomment below and update the code to test CustomerCommunication
      //var instance = new SimpleBillyApi.CustomerCommunication();
      //expect(instance).to.be.a(SimpleBillyApi.CustomerCommunication);
    });
