...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AttachmentVersion();
  });
  ...
  describe('AttachmentVersion', function() {
    it('should create an instance of AttachmentVersion', function() {
      // uncomment below and update the code to test AttachmentVersion
      //var instance = new SimpleBillyApi.AttachmentVersion();
      //expect(instance).to.be.a(SimpleBillyApi.AttachmentVersion);
    });
