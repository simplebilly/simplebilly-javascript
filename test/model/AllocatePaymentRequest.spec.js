...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.AllocatePaymentRequest();
  });
  ...
  describe('AllocatePaymentRequest', function() {
    it('should create an instance of AllocatePaymentRequest', function() {
      // uncomment below and update the code to test AllocatePaymentRequest
      //var instance = new SimpleBillyApi.AllocatePaymentRequest();
      //expect(instance).to.be.a(SimpleBillyApi.AllocatePaymentRequest);
    });
