...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.JobPostingFilter();
  });
  ...
  describe('JobPostingFilter', function() {
    it('should create an instance of JobPostingFilter', function() {
      // uncomment below and update the code to test JobPostingFilter
      //var instance = new SimpleBillyApi.JobPostingFilter();
      //expect(instance).to.be.a(SimpleBillyApi.JobPostingFilter);
    });
