...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.InstituteCheckItem();
  });
  ...
  describe('InstituteCheckItem', function() {
    it('should create an instance of InstituteCheckItem', function() {
      // uncomment below and update the code to test InstituteCheckItem
      //var instance = new SimpleBillyApi.InstituteCheckItem();
      //expect(instance).to.be.a(SimpleBillyApi.InstituteCheckItem);
    });
