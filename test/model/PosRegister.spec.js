...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PosRegister();
  });
  ...
  describe('PosRegister', function() {
    it('should create an instance of PosRegister', function() {
      // uncomment below and update the code to test PosRegister
      //var instance = new SimpleBillyApi.PosRegister();
      //expect(instance).to.be.a(SimpleBillyApi.PosRegister);
    });
