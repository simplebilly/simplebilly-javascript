...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.LegalDocumentReset();
  });
  ...
  describe('LegalDocumentReset', function() {
    it('should create an instance of LegalDocumentReset', function() {
      // uncomment below and update the code to test LegalDocumentReset
      //var instance = new SimpleBillyApi.LegalDocumentReset();
      //expect(instance).to.be.a(SimpleBillyApi.LegalDocumentReset);
    });
