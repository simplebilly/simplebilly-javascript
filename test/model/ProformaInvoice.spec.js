...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ProformaInvoice();
  });
  ...
  describe('ProformaInvoice', function() {
    it('should create an instance of ProformaInvoice', function() {
      // uncomment below and update the code to test ProformaInvoice
      //var instance = new SimpleBillyApi.ProformaInvoice();
      //expect(instance).to.be.a(SimpleBillyApi.ProformaInvoice);
    });
