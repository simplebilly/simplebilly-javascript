...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GewinnverwendungsZeile();
  });
  ...
  describe('GewinnverwendungsZeile', function() {
    it('should create an instance of GewinnverwendungsZeile', function() {
      // uncomment below and update the code to test GewinnverwendungsZeile
      //var instance = new SimpleBillyApi.GewinnverwendungsZeile();
      //expect(instance).to.be.a(SimpleBillyApi.GewinnverwendungsZeile);
    });
