...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ForgotPasswordRequest();
  });
  ...
  describe('ForgotPasswordRequest', function() {
    it('should create an instance of ForgotPasswordRequest', function() {
      ...
      //var instance = new SimpleBillyApi.ForgotPasswordRequest();
      //expect(instance).to.be.a(SimpleBillyApi.ForgotPasswordRequest);
    });
