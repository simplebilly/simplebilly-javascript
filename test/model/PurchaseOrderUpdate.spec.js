...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PurchaseOrderUpdate();
  });
  ...
  describe('PurchaseOrderUpdate', function() {
    it('should create an instance of PurchaseOrderUpdate', function() {
      // uncomment below and update the code to test PurchaseOrderUpdate
      //var instance = new SimpleBillyApi.PurchaseOrderUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.PurchaseOrderUpdate);
    });
