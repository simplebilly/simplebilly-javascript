...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.StockTransfer();
  });
  ...
  describe('StockTransfer', function() {
    it('should create an instance of StockTransfer', function() {
      // uncomment below and update the code to test StockTransfer
      //var instance = new SimpleBillyApi.StockTransfer();
      //expect(instance).to.be.a(SimpleBillyApi.StockTransfer);
    });
