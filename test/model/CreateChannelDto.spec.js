...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CreateChannelDto();
  });
  ...
  describe('CreateChannelDto', function() {
    it('should create an instance of CreateChannelDto', function() {
      // uncomment below and update the code to test CreateChannelDto
      //var instance = new SimpleBillyApi.CreateChannelDto();
      //expect(instance).to.be.a(SimpleBillyApi.CreateChannelDto);
    });
