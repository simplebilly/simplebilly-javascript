...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PackingQueue();
  });
  ...
  describe('PackingQueue', function() {
    it('should create an instance of PackingQueue', function() {
      // uncomment below and update the code to test PackingQueue
      //var instance = new SimpleBillyApi.PackingQueue();
      //expect(instance).to.be.a(SimpleBillyApi.PackingQueue);
    });
