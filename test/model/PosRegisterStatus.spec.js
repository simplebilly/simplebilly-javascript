...
(function(root, factory) {
  ...
  describe('PosRegisterStatus', function() {
    it('should create an instance of PosRegisterStatus', function() {
      // uncomment below and update the code to test PosRegisterStatus
      //var instance = new SimpleBillyApi.PosRegisterStatus();
      //expect(instance).to.be.a(SimpleBillyApi.PosRegisterStatus);
    });
