...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PriceTier();
  });
  ...
  describe('PriceTier', function() {
    it('should create an instance of PriceTier', function() {
      // uncomment below and update the code to test PriceTier
      //var instance = new SimpleBillyApi.PriceTier();
      //expect(instance).to.be.a(SimpleBillyApi.PriceTier);
    });
