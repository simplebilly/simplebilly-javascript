...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ProformaInvoiceUpdate();
  });
  ...
  describe('ProformaInvoiceUpdate', function() {
    it('should create an instance of ProformaInvoiceUpdate', function() {
      // uncomment below and update the code to test ProformaInvoiceUpdate
      //var instance = new SimpleBillyApi.ProformaInvoiceUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.ProformaInvoiceUpdate);
    });
