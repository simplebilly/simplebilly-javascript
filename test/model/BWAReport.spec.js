...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.BWAReport();
  });
  ...
  describe('BWAReport', function() {
    it('should create an instance of BWAReport', function() {
      // uncomment below and update the code to test BWAReport
      //var instance = new SimpleBillyApi.BWAReport();
      //expect(instance).to.be.a(SimpleBillyApi.BWAReport);
    });
