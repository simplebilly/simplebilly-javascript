...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.XRechnungResponse();
  });
  ...
  describe('XRechnungResponse', function() {
    it('should create an instance of XRechnungResponse', function() {
      // uncomment below and update the code to test XRechnungResponse
      //var instance = new SimpleBillyApi.XRechnungResponse();
      //expect(instance).to.be.a(SimpleBillyApi.XRechnungResponse);
    });
