...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CreateConnectionRequest();
  });
  ...
  describe('CreateConnectionRequest', function() {
    it('should create an instance of CreateConnectionRequest', function() {
      ...
      //var instance = new SimpleBillyApi.CreateConnectionRequest();
      //expect(instance).to.be.a(SimpleBillyApi.CreateConnectionRequest);
    });
