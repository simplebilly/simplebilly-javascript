...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ExpenseItem();
  });
  ...
  describe('ExpenseItem', function() {
    it('should create an instance of ExpenseItem', function() {
      // uncomment below and update the code to test ExpenseItem
      //var instance = new SimpleBillyApi.ExpenseItem();
      //expect(instance).to.be.a(SimpleBillyApi.ExpenseItem);
    });
