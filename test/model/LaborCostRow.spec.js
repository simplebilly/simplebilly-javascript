...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.LaborCostRow();
  });
  ...
  describe('LaborCostRow', function() {
    it('should create an instance of LaborCostRow', function() {
      // uncomment below and update the code to test LaborCostRow
      //var instance = new SimpleBillyApi.LaborCostRow();
      //expect(instance).to.be.a(SimpleBillyApi.LaborCostRow);
    });
