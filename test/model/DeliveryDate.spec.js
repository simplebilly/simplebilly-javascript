...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DeliveryDate();
  });
  ...
  describe('DeliveryDate', function() {
    it('should create an instance of DeliveryDate', function() {
      // uncomment below and update the code to test DeliveryDate
      //var instance = new SimpleBillyApi.DeliveryDate();
      //expect(instance).to.be.a(SimpleBillyApi.DeliveryDate);
    });
