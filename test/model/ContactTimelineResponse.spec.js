...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ContactTimelineResponse();
  });
  ...
  describe('ContactTimelineResponse', function() {
    it('should create an instance of ContactTimelineResponse', function() {
      // uncomment below and update the code to test ContactTimelineResponse
      //var instance = new SimpleBillyApi.ContactTimelineResponse();
      //expect(instance).to.be.a(SimpleBillyApi.ContactTimelineResponse);
    });
