...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OffenlegungItem();
  });
  ...
  describe('OffenlegungItem', function() {
    it('should create an instance of OffenlegungItem', function() {
      // uncomment below and update the code to test OffenlegungItem
      //var instance = new SimpleBillyApi.OffenlegungItem();
      //expect(instance).to.be.a(SimpleBillyApi.OffenlegungItem);
    });
