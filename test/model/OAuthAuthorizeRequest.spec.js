...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OAuthAuthorizeRequest();
  });
  ...
  describe('OAuthAuthorizeRequest', function() {
    it('should create an instance of OAuthAuthorizeRequest', function() {
      // uncomment below and update the code to test OAuthAuthorizeRequest
      //var instance = new SimpleBillyApi.OAuthAuthorizeRequest();
      //expect(instance).to.be.a(SimpleBillyApi.OAuthAuthorizeRequest);
    });
