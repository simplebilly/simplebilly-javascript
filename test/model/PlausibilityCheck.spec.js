...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PlausibilityCheck();
  });
  ...
  describe('PlausibilityCheck', function() {
    it('should create an instance of PlausibilityCheck', function() {
      // uncomment below and update the code to test PlausibilityCheck
      //var instance = new SimpleBillyApi.PlausibilityCheck();
      //expect(instance).to.be.a(SimpleBillyApi.PlausibilityCheck);
    });
