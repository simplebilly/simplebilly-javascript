...
(function(root, factory) {
  ...
  describe('PosTableStatus', function() {
    it('should create an instance of PosTableStatus', function() {
      // uncomment below and update the code to test PosTableStatus
      //var instance = new SimpleBillyApi.PosTableStatus();
      //expect(instance).to.be.a(SimpleBillyApi.PosTableStatus);
    });
