...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DeliveryDateUpdate();
  });
  ...
  describe('DeliveryDateUpdate', function() {
    it('should create an instance of DeliveryDateUpdate', function() {
      // uncomment below and update the code to test DeliveryDateUpdate
      //var instance = new SimpleBillyApi.DeliveryDateUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.DeliveryDateUpdate);
    });
