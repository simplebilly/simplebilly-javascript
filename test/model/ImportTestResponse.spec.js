...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ImportTestResponse();
  });
  ...
  describe('ImportTestResponse', function() {
    it('should create an instance of ImportTestResponse', function() {
      // uncomment below and update the code to test ImportTestResponse
      //var instance = new SimpleBillyApi.ImportTestResponse();
      //expect(instance).to.be.a(SimpleBillyApi.ImportTestResponse);
    });
