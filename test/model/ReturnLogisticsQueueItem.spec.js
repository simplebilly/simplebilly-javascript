...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ReturnLogisticsQueueItem();
  });
  ...
  describe('ReturnLogisticsQueueItem', function() {
    it('should create an instance of ReturnLogisticsQueueItem', function() {
      // uncomment below and update the code to test ReturnLogisticsQueueItem
      //var instance = new SimpleBillyApi.ReturnLogisticsQueueItem();
      //expect(instance).to.be.a(SimpleBillyApi.ReturnLogisticsQueueItem);
    });
