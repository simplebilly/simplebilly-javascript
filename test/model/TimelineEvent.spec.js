...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.TimelineEvent();
  });
  ...
  describe('TimelineEvent', function() {
    it('should create an instance of TimelineEvent', function() {
      // uncomment below and update the code to test TimelineEvent
      //var instance = new SimpleBillyApi.TimelineEvent();
      //expect(instance).to.be.a(SimpleBillyApi.TimelineEvent);
    });
