...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.JobPostingUpdate();
  });
  ...
  describe('JobPostingUpdate', function() {
    it('should create an instance of JobPostingUpdate', function() {
      // uncomment below and update the code to test JobPostingUpdate
      //var instance = new SimpleBillyApi.JobPostingUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.JobPostingUpdate);
    });
