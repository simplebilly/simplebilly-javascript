...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GatewayOAuthAuthorizeRequest();
  });
  ...
  describe('GatewayOAuthAuthorizeRequest', function() {
    it('should create an instance of GatewayOAuthAuthorizeRequest', function() {
      // uncomment below and update the code to test GatewayOAuthAuthorizeRequest
      //var instance = new SimpleBillyApi.GatewayOAuthAuthorizeRequest();
      //expect(instance).to.be.a(SimpleBillyApi.GatewayOAuthAuthorizeRequest);
    });

    it('should have the property gatewayType (base name: "gateway_type")', function() {
