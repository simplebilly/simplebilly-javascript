...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CouponCreate();
  });
  ...
  describe('CouponCreate', function() {
    it('should create an instance of CouponCreate', function() {
      // uncomment below and update the code to test CouponCreate
      //var instance = new SimpleBillyApi.CouponCreate();
      //expect(instance).to.be.a(SimpleBillyApi.CouponCreate);
    });
