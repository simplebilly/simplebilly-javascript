...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ShareholderCreate();
  });
  ...
  describe('ShareholderCreate', function() {
    it('should create an instance of ShareholderCreate', function() {
      // uncomment below and update the code to test ShareholderCreate
      //var instance = new SimpleBillyApi.ShareholderCreate();
      //expect(instance).to.be.a(SimpleBillyApi.ShareholderCreate);
    });
    ...
    it('should have the property shareNumber (base name: "shareNumber")', function() {
      // uncomment below and update the code to test the property shareNumber
      //var instance = new SimpleBillyApi.ShareholderCreate();
      //expect(instance).to.be();
    });
