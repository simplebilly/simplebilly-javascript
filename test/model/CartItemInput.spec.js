...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CartItemInput();
  });
  ...
  describe('CartItemInput', function() {
    it('should create an instance of CartItemInput', function() {
      // uncomment below and update the code to test CartItemInput
      //var instance = new SimpleBillyApi.CartItemInput();
      //expect(instance).to.be.a(SimpleBillyApi.CartItemInput);
    });
