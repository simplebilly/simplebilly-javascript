...
(function(root, factory) {
  ...
  describe('SmtpEncryption', function() {
    it('should create an instance of SmtpEncryption', function() {
      // uncomment below and update the code to test SmtpEncryption
      //var instance = new SimpleBillyApi.SmtpEncryption();
      //expect(instance).to.be.a(SimpleBillyApi.SmtpEncryption);
    });
