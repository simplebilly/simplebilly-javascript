...
(function(root, factory) {
  ...
  describe('ReminderLevel', function() {
    it('should create an instance of ReminderLevel', function() {
      // uncomment below and update the code to test ReminderLevel
      //var instance = new SimpleBillyApi.ReminderLevel();
      //expect(instance).to.be.a(SimpleBillyApi.ReminderLevel);
    });
