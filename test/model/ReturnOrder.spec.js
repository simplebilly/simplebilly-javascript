...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ReturnOrder();
  });
  ...
  describe('ReturnOrder', function() {
    it('should create an instance of ReturnOrder', function() {
      ...
      //var instance = new SimpleBillyApi.ReturnOrder();
      //expect(instance).to.be.a(SimpleBillyApi.ReturnOrder);
    });

    it('should have the property customerContactId (base name: "customerContactId")', function() {
      // uncomment below and update the code to test the property customerContactId
      //var instance = new SimpleBillyApi.ReturnOrder();
