...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.BalanceSheet();
  });
  ...
  describe('BalanceSheet', function() {
    it('should create an instance of BalanceSheet', function() {
      ...
      //var instance = new SimpleBillyApi.BalanceSheet();
      //expect(instance).to.be.a(SimpleBillyApi.BalanceSheet);
    });
    ...
    it('should have the property equityLiabilities (base name: "equity_liabilities")', function() {
      // uncomment below and update the code to test the property equityLiabilities
      //var instance = new SimpleBillyApi.BalanceSheet();
      //expect(instance).to.be();
    });
    ...
    it('should have the property totalEquityLiabilities (base name: "total_equity_liabilities")', function() {
      // uncomment below and update the code to test the property totalEquityLiabilities
      //var instance = new SimpleBillyApi.BalanceSheet();
      //expect(instance).to.be();
    });
