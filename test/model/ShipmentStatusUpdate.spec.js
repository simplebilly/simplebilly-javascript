...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ShipmentStatusUpdate();
  });
  ...
  describe('ShipmentStatusUpdate', function() {
    it('should create an instance of ShipmentStatusUpdate', function() {
      // uncomment below and update the code to test ShipmentStatusUpdate
      //var instance = new SimpleBillyApi.ShipmentStatusUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.ShipmentStatusUpdate);
    });
