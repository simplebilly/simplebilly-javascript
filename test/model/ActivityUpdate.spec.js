...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ActivityUpdate();
  });
  ...
  describe('ActivityUpdate', function() {
    it('should create an instance of ActivityUpdate', function() {
      // uncomment below and update the code to test ActivityUpdate
      //var instance = new SimpleBillyApi.ActivityUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.ActivityUpdate);
    });
