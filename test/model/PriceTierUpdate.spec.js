...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PriceTierUpdate();
  });
  ...
  describe('PriceTierUpdate', function() {
    it('should create an instance of PriceTierUpdate', function() {
      // uncomment below and update the code to test PriceTierUpdate
      //var instance = new SimpleBillyApi.PriceTierUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.PriceTierUpdate);
    });
