...
(function(root, factory) {
  ...
  describe('SupportChannelType', function() {
    it('should create an instance of SupportChannelType', function() {
      // uncomment below and update the code to test SupportChannelType
      //var instance = new SimpleBillyApi.SupportChannelType();
      //expect(instance).to.be.a(SimpleBillyApi.SupportChannelType);
    });
