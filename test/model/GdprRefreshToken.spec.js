...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.GdprRefreshToken();
  });
  ...
  describe('GdprRefreshToken', function() {
    it('should create an instance of GdprRefreshToken', function() {
      // uncomment below and update the code to test GdprRefreshToken
      //var instance = new SimpleBillyApi.GdprRefreshToken();
      //expect(instance).to.be.a(SimpleBillyApi.GdprRefreshToken);
    });
