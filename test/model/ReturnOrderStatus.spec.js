...
(function(root, factory) {
  ...
  describe('ReturnOrderStatus', function() {
    it('should create an instance of ReturnOrderStatus', function() {
      // uncomment below and update the code to test ReturnOrderStatus
      //var instance = new SimpleBillyApi.ReturnOrderStatus();
      //expect(instance).to.be.a(SimpleBillyApi.ReturnOrderStatus);
    });
