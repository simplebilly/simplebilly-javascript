...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OrderConfirmation();
  });
  ...
  describe('OrderConfirmation', function() {
    it('should create an instance of OrderConfirmation', function() {
      // uncomment below and update the code to test OrderConfirmation
      //var instance = new SimpleBillyApi.OrderConfirmation();
      //expect(instance).to.be.a(SimpleBillyApi.OrderConfirmation);
    });
