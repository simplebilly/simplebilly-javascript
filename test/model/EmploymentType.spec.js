...
(function(root, factory) {
  ...
  describe('EmploymentType', function() {
    it('should create an instance of EmploymentType', function() {
      // uncomment below and update the code to test EmploymentType
      //var instance = new SimpleBillyApi.EmploymentType();
      //expect(instance).to.be.a(SimpleBillyApi.EmploymentType);
    });
