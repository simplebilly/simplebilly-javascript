...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SalesVolumeItem();
  });
  ...
  describe('SalesVolumeItem', function() {
    it('should create an instance of SalesVolumeItem', function() {
      // uncomment below and update the code to test SalesVolumeItem
      //var instance = new SimpleBillyApi.SalesVolumeItem();
      //expect(instance).to.be.a(SimpleBillyApi.SalesVolumeItem);
    });
