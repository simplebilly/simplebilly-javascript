...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.UserTenantInfo();
  });
  ...
  describe('UserTenantInfo', function() {
    it('should create an instance of UserTenantInfo', function() {
      // uncomment below and update the code to test UserTenantInfo
      //var instance = new SimpleBillyApi.UserTenantInfo();
      //expect(instance).to.be.a(SimpleBillyApi.UserTenantInfo);
    });
