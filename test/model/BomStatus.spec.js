...
(function(root, factory) {
  ...
  describe('BomStatus', function() {
    it('should create an instance of BomStatus', function() {
      // uncomment below and update the code to test BomStatus
      //var instance = new SimpleBillyApi.BomStatus();
      //expect(instance).to.be.a(SimpleBillyApi.BomStatus);
    });
