...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.TrackOrderRequest();
  });
  ...
  describe('TrackOrderRequest', function() {
    it('should create an instance of TrackOrderRequest', function() {
      // uncomment below and update the code to test TrackOrderRequest
      //var instance = new SimpleBillyApi.TrackOrderRequest();
      //expect(instance).to.be.a(SimpleBillyApi.TrackOrderRequest);
    });
