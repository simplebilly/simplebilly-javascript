...
(function(root, factory) {
  ...
  describe('CommunicationChannel', function() {
    it('should create an instance of CommunicationChannel', function() {
      // uncomment below and update the code to test CommunicationChannel
      //var instance = new SimpleBillyApi.CommunicationChannel();
      //expect(instance).to.be.a(SimpleBillyApi.CommunicationChannel);
    });
