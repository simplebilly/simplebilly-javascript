...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ApiResponseVecPlanDataInner();
  });
  ...
  describe('ApiResponseVecPlanDataInner', function() {
    it('should create an instance of ApiResponseVecPlanDataInner', function() {
      // uncomment below and update the code to test ApiResponseVecPlanDataInner
      //var instance = new SimpleBillyApi.ApiResponseVecPlanDataInner();
      //expect(instance).to.be.a(SimpleBillyApi.ApiResponseVecPlanDataInner);
    });
