...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PaymentGatewayUpdate();
  });
  ...
  describe('PaymentGatewayUpdate', function() {
    it('should create an instance of PaymentGatewayUpdate', function() {
      // uncomment below and update the code to test PaymentGatewayUpdate
      //var instance = new SimpleBillyApi.PaymentGatewayUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.PaymentGatewayUpdate);
    });
