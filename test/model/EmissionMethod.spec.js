...
(function(root, factory) {
  ...
  describe('EmissionMethod', function() {
    it('should create an instance of EmissionMethod', function() {
      // uncomment below and update the code to test EmissionMethod
      //var instance = new SimpleBillyApi.EmissionMethod();
      //expect(instance).to.be.a(SimpleBillyApi.EmissionMethod);
    });
