...
(function(root, factory) {
  ...
  describe('PurchaseOrderStatus', function() {
    it('should create an instance of PurchaseOrderStatus', function() {
      // uncomment below and update the code to test PurchaseOrderStatus
      //var instance = new SimpleBillyApi.PurchaseOrderStatus();
      //expect(instance).to.be.a(SimpleBillyApi.PurchaseOrderStatus);
    });
