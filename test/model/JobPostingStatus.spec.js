...
(function(root, factory) {
  ...
  describe('JobPostingStatus', function() {
    it('should create an instance of JobPostingStatus', function() {
      // uncomment below and update the code to test JobPostingStatus
      //var instance = new SimpleBillyApi.JobPostingStatus();
      //expect(instance).to.be.a(SimpleBillyApi.JobPostingStatus);
    });
