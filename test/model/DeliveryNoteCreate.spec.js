...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DeliveryNoteCreate();
  });
  ...
  describe('DeliveryNoteCreate', function() {
    it('should create an instance of DeliveryNoteCreate', function() {
      // uncomment below and update the code to test DeliveryNoteCreate
      //var instance = new SimpleBillyApi.DeliveryNoteCreate();
      //expect(instance).to.be.a(SimpleBillyApi.DeliveryNoteCreate);
    });
