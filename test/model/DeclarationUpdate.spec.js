...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.DeclarationUpdate();
  });
  ...
  describe('DeclarationUpdate', function() {
    it('should create an instance of DeclarationUpdate', function() {
      // uncomment below and update the code to test DeclarationUpdate
      //var instance = new SimpleBillyApi.DeclarationUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.DeclarationUpdate);
    });
