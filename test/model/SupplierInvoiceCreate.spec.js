...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.SupplierInvoiceCreate();
  });
  ...
  describe('SupplierInvoiceCreate', function() {
    it('should create an instance of SupplierInvoiceCreate', function() {
      // uncomment below and update the code to test SupplierInvoiceCreate
      //var instance = new SimpleBillyApi.SupplierInvoiceCreate();
      //expect(instance).to.be.a(SimpleBillyApi.SupplierInvoiceCreate);
    });
