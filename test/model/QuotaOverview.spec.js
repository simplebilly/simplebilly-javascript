...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.QuotaOverview();
  });
  ...
  describe('QuotaOverview', function() {
    it('should create an instance of QuotaOverview', function() {
      // uncomment below and update the code to test QuotaOverview
      //var instance = new SimpleBillyApi.QuotaOverview();
      //expect(instance).to.be.a(SimpleBillyApi.QuotaOverview);
    });
