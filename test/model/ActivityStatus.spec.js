...
(function(root, factory) {
  ...
  describe('ActivityStatus', function() {
    it('should create an instance of ActivityStatus', function() {
      // uncomment below and update the code to test ActivityStatus
      //var instance = new SimpleBillyApi.ActivityStatus();
      //expect(instance).to.be.a(SimpleBillyApi.ActivityStatus);
    });
