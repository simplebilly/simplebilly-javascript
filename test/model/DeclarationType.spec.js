...
(function(root, factory) {
  ...
  describe('DeclarationType', function() {
    it('should create an instance of DeclarationType', function() {
      // uncomment below and update the code to test DeclarationType
      //var instance = new SimpleBillyApi.DeclarationType();
      //expect(instance).to.be.a(SimpleBillyApi.DeclarationType);
    });
