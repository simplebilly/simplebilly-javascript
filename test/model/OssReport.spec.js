...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OssReport();
  });
  ...
  describe('OssReport', function() {
    it('should create an instance of OssReport', function() {
      // uncomment below and update the code to test OssReport
      //var instance = new SimpleBillyApi.OssReport();
      //expect(instance).to.be.a(SimpleBillyApi.OssReport);
    });
