...
(function(root, factory) {
  ...
  describe('ServiceJobStatus', function() {
    it('should create an instance of ServiceJobStatus', function() {
      // uncomment below and update the code to test ServiceJobStatus
      //var instance = new SimpleBillyApi.ServiceJobStatus();
      //expect(instance).to.be.a(SimpleBillyApi.ServiceJobStatus);
    });
