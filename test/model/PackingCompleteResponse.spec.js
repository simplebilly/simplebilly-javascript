...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.PackingCompleteResponse();
  });
  ...
  describe('PackingCompleteResponse', function() {
    it('should create an instance of PackingCompleteResponse', function() {
      // uncomment below and update the code to test PackingCompleteResponse
      //var instance = new SimpleBillyApi.PackingCompleteResponse();
      //expect(instance).to.be.a(SimpleBillyApi.PackingCompleteResponse);
    });
