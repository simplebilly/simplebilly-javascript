...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.CreateShipmentRequest();
  });
  ...
  describe('CreateShipmentRequest', function() {
    it('should create an instance of CreateShipmentRequest', function() {
      ...
      //var instance = new SimpleBillyApi.CreateShipmentRequest();
      //expect(instance).to.be.a(SimpleBillyApi.CreateShipmentRequest);
    });
