...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ConfigFieldInfo();
  });
  ...
  describe('ConfigFieldInfo', function() {
    it('should create an instance of ConfigFieldInfo', function() {
      // uncomment below and update the code to test ConfigFieldInfo
      //var instance = new SimpleBillyApi.ConfigFieldInfo();
      //expect(instance).to.be.a(SimpleBillyApi.ConfigFieldInfo);
    });
