...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.MirrorTriggerResponse();
  });
  ...
  describe('MirrorTriggerResponse', function() {
    it('should create an instance of MirrorTriggerResponse', function() {
      // uncomment below and update the code to test MirrorTriggerResponse
      //var instance = new SimpleBillyApi.MirrorTriggerResponse();
      //expect(instance).to.be.a(SimpleBillyApi.MirrorTriggerResponse);
    });
