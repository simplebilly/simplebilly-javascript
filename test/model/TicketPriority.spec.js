...
(function(root, factory) {
  ...
  describe('TicketPriority', function() {
    it('should create an instance of TicketPriority', function() {
      // uncomment below and update the code to test TicketPriority
      //var instance = new SimpleBillyApi.TicketPriority();
      //expect(instance).to.be.a(SimpleBillyApi.TicketPriority);
    });
