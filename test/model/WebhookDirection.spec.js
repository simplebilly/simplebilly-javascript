...
(function(root, factory) {
  ...
  describe('WebhookDirection', function() {
    it('should create an instance of WebhookDirection', function() {
      // uncomment below and update the code to test WebhookDirection
      //var instance = new SimpleBillyApi.WebhookDirection();
      //expect(instance).to.be.a(SimpleBillyApi.WebhookDirection);
    });
