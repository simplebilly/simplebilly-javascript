...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.BomUpdate();
  });
  ...
  describe('BomUpdate', function() {
    it('should create an instance of BomUpdate', function() {
      // uncomment below and update the code to test BomUpdate
      //var instance = new SimpleBillyApi.BomUpdate();
      //expect(instance).to.be.a(SimpleBillyApi.BomUpdate);
    });
    ...
    it('should have the property outputQuantity (base name: "outputQuantity")', function() {
      // uncomment below and update the code to test the property outputQuantity
      //var instance = new SimpleBillyApi.BomUpdate();
      //expect(instance).to.be();
    });
