...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.OpenItem();
  });
  ...
  describe('OpenItem', function() {
    it('should create an instance of OpenItem', function() {
      // uncomment below and update the code to test OpenItem
      //var instance = new SimpleBillyApi.OpenItem();
      //expect(instance).to.be.a(SimpleBillyApi.OpenItem);
    });
    ...
    it('should have the property daysOverdue (base name: "days_overdue")', function() {
      // uncomment below and update the code to test the property daysOverdue
      //var instance = new SimpleBillyApi.OpenItem();
      //expect(instance).to.be();
    });
    ...
    it('should have the property reminderLevel (base name: "reminder_level")', function() {
      // uncomment below and update the code to test the property reminderLevel
      //var instance = new SimpleBillyApi.OpenItem();
      //expect(instance).to.be();
    });
