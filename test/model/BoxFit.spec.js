...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.BoxFit();
  });
  ...
  describe('BoxFit', function() {
    it('should create an instance of BoxFit', function() {
      // uncomment below and update the code to test BoxFit
      //var instance = new SimpleBillyApi.BoxFit();
      //expect(instance).to.be.a(SimpleBillyApi.BoxFit);
    });
    ...
    it('should have the property volumeCm3 (base name: "volume_cm3")', function() {
      // uncomment below and update the code to test the property volumeCm3
      //var instance = new SimpleBillyApi.BoxFit();
      //expect(instance).to.be();
    });
