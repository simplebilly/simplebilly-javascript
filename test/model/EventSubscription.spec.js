...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.EventSubscription();
  });
  ...
  describe('EventSubscription', function() {
    it('should create an instance of EventSubscription', function() {
      ...
      //var instance = new SimpleBillyApi.EventSubscription();
      //expect(instance).to.be.a(SimpleBillyApi.EventSubscription);
    });
