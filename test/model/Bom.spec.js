...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.Bom();
  });
  ...
  describe('Bom', function() {
    it('should create an instance of Bom', function() {
      // uncomment below and update the code to test Bom
      //var instance = new SimpleBillyApi.Bom();
      //expect(instance).to.be.a(SimpleBillyApi.Bom);
    });
