...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ResetPasswordRequest();
  });
  ...
  describe('ResetPasswordRequest', function() {
    it('should create an instance of ResetPasswordRequest', function() {
      ...
      //var instance = new SimpleBillyApi.ResetPasswordRequest();
      //expect(instance).to.be.a(SimpleBillyApi.ResetPasswordRequest);
    });
