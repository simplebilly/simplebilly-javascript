...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.JobPosting();
  });
  ...
  describe('JobPosting', function() {
    it('should create an instance of JobPosting', function() {
      // uncomment below and update the code to test JobPosting
      //var instance = new SimpleBillyApi.JobPosting();
      //expect(instance).to.be.a(SimpleBillyApi.JobPosting);
    });
