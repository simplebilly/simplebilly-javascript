...
(function(root, factory) {
  ...
  describe('PostingCategoryType', function() {
    it('should create an instance of PostingCategoryType', function() {
      // uncomment below and update the code to test PostingCategoryType
      //var instance = new SimpleBillyApi.PostingCategoryType();
      //expect(instance).to.be.a(SimpleBillyApi.PostingCategoryType);
    });
