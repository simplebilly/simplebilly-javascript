...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.WarehouseStock();
  });
  ...
  describe('WarehouseStock', function() {
    it('should create an instance of WarehouseStock', function() {
      // uncomment below and update the code to test WarehouseStock
      //var instance = new SimpleBillyApi.WarehouseStock();
      //expect(instance).to.be.a(SimpleBillyApi.WarehouseStock);
    });
