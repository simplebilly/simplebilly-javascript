...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ApiResponseUserProfileData();
  });
  ...
  describe('ApiResponseUserProfileData', function() {
    it('should create an instance of ApiResponseUserProfileData', function() {
      // uncomment below and update the code to test ApiResponseUserProfileData
      //var instance = new SimpleBillyApi.ApiResponseUserProfileData();
      //expect(instance).to.be.a(SimpleBillyApi.ApiResponseUserProfileData);
    });
