...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.BankLookup();
  });
  ...
  describe('BankLookup', function() {
    it('should create an instance of BankLookup', function() {
      // uncomment below and update the code to test BankLookup
      //var instance = new SimpleBillyApi.BankLookup();
      //expect(instance).to.be.a(SimpleBillyApi.BankLookup);
    });
    ...
    it('should have the property nextgenpsd2Url (base name: "nextgenpsd2_url")', function() {
      // uncomment below and update the code to test the property nextgenpsd2Url
      //var instance = new SimpleBillyApi.BankLookup();
      //expect(instance).to.be();
    });

    it('should have the property psd2Supported (base name: "psd2_supported")', function() {
      // uncomment below and update the code to test the property psd2Supported
      //var instance = new SimpleBillyApi.BankLookup();
      //expect(instance).to.be();
    });
