...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SimpleBillyApi.ApiResponseVecUserTenantInfoDataInner();
  });
  ...
  describe('ApiResponseVecUserTenantInfoDataInner', function() {
    it('should create an instance of ApiResponseVecUserTenantInfoDataInner', function() {
      // uncomment below and update the code to test ApiResponseVecUserTenantInfoDataInner
      //var instance = new SimpleBillyApi.ApiResponseVecUserTenantInfoDataInner();
      //expect(instance).to.be.a(SimpleBillyApi.ApiResponseVecUserTenantInfoDataInner);
    });
