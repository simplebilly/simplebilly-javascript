...
* @readonly
*/
export default class RfqStatus {
    ...
    /**
    * Returns a <code>RfqStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RfqStatus} The enum <code>RfqStatus</code> value.
    */
