...
/**
* Enum class EmissionTargetScope.
* @enum {}
* @readonly
*/
export default class EmissionTargetScope {
    ...
    /**
    * Returns a <code>EmissionTargetScope</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EmissionTargetScope} The enum <code>EmissionTargetScope</code> value.
    */
