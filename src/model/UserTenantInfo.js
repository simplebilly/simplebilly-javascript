...
/**
 * The UserTenantInfo model module.
 * @module model/UserTenantInfo
 * @version 0.1.0
 */
class UserTenantInfo {
    /**
     * Constructs a new <code>UserTenantInfo</code>.
     * @alias module:model/UserTenantInfo
     * @param role {String} 
    ...
    constructor(role, tenantId, tenantName) { 
        ...
        UserTenantInfo.initialize(this, role, tenantId, tenantName);
    }
    ...
    /**
     * Constructs a <code>UserTenantInfo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserTenantInfo} obj Optional instance to populate.
     * @return {module:model/UserTenantInfo} The populated <code>UserTenantInfo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserTenantInfo();
    ...
    /**
     * Validates the JSON data with respect to <code>UserTenantInfo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UserTenantInfo</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UserTenantInfo.RequiredProperties) {
...
UserTenantInfo.RequiredProperties = ["role", "tenant_id", "tenant_name"];

/**
 * @member {String} custom_domain
 */
UserTenantInfo.prototype['custom_domain'] = undefined;

/**
 * @member {String} role
 */
UserTenantInfo.prototype['role'] = undefined;

/**
 * @member {String} subdomain
 */
UserTenantInfo.prototype['subdomain'] = undefined;

/**
 * @member {String} tenant_id
 */
UserTenantInfo.prototype['tenant_id'] = undefined;

/**
 * @member {String} tenant_name
 */
UserTenantInfo.prototype['tenant_name'] = undefined;
