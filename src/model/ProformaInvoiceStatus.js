...
/**
* Enum class ProformaInvoiceStatus.
* @enum {}
* @readonly
*/
export default class ProformaInvoiceStatus {
    ...
    /**
    * Returns a <code>ProformaInvoiceStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProformaInvoiceStatus} The enum <code>ProformaInvoiceStatus</code> value.
    */
