...
* @readonly
*/
export default class DeclarationType {
    ...
    /**
    * Returns a <code>DeclarationType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeclarationType} The enum <code>DeclarationType</code> value.
    */
