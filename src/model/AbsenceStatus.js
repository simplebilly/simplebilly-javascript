...
* @readonly
*/
export default class AbsenceStatus {
    ...
    /**
    * Returns a <code>AbsenceStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AbsenceStatus} The enum <code>AbsenceStatus</code> value.
    */
