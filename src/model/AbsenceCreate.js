...
/**
 * The AbsenceCreate model module.
 * @module model/AbsenceCreate
 * @version 0.1.0
 */
class AbsenceCreate {
    /**
     * Constructs a new <code>AbsenceCreate</code>.
     * @alias module:model/AbsenceCreate
     */
    constructor() { 
        
        AbsenceCreate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AbsenceCreate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AbsenceCreate} obj Optional instance to populate.
     * @return {module:model/AbsenceCreate} The populated <code>AbsenceCreate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AbsenceCreate();
    ...
    /**
     * Validates the JSON data with respect to <code>AbsenceCreate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AbsenceCreate</code>.
     */
 ...
 */
AbsenceCreate.prototype['absenceType'] = undefined;

/**
 * @member {Date} approvedAt
 */
AbsenceCreate.prototype['approvedAt'] = undefined;

/**
 * References the user entity.
 * @member {String} approvedBy
 */
AbsenceCreate.prototype['approvedBy'] = undefined;

/**
 * References the employee entity.
 * @member {String} employeeId
 */
AbsenceCreate.prototype['employeeId'] = undefined;

/**
 * @member {Date} endDate
 */
AbsenceCreate.prototype['endDate'] = undefined;

/**
 * @member {String} notes
 */
AbsenceCreate.prototype['notes'] = undefined;

/**
 * @member {Date} startDate
 */
AbsenceCreate.prototype['startDate'] = undefined;

/**
 * One of \"pending\", \"approved\", \"rejected\", \"cancelled\".
 * @member {module:model/AbsenceStatus} status
 */
AbsenceCreate.prototype['status'] = undefined;
