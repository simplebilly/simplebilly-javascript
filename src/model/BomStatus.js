...
* @readonly
*/
export default class BomStatus {
    ...
    /**
    * Returns a <code>BomStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/BomStatus} The enum <code>BomStatus</code> value.
    */
