...
class ProductAttribute {
    ...
    constructor(name, productId, value) { 
        ...
        ProductAttribute.initialize(this, name, productId, value);
    }
...
ProductAttribute.RequiredProperties = ["name", "productId", "value"];

/**
 * Whether this attribute participates in the shop's faceted filters.
 * @member {Boolean} isFilterable
 */
ProductAttribute.prototype['isFilterable'] = undefined;
 ...
 */
ProductAttribute.prototype['productId'] = undefined;

/**
 * Optional unit of measure for numeric attributes, e.g. `g`, `cm`.
 * @member {String} unit
 */
ProductAttribute.prototype['unit'] = undefined;
