...
* @readonly
*/
export default class ProductionOrderStatus {
    ...
    /**
    * Returns a <code>ProductionOrderStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ProductionOrderStatus} The enum <code>ProductionOrderStatus</code> value.
    */
