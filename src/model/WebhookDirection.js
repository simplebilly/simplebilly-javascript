...
* @readonly
*/
export default class WebhookDirection {
    ...
    /**
    * Returns a <code>WebhookDirection</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WebhookDirection} The enum <code>WebhookDirection</code> value.
    */
