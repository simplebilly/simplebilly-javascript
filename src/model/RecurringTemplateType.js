...
/**
* Enum class RecurringTemplateType.
* @enum {}
* @readonly
*/
export default class RecurringTemplateType {
    ...
    /**
    * Returns a <code>RecurringTemplateType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RecurringTemplateType} The enum <code>RecurringTemplateType</code> value.
    */
