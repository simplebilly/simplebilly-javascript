...
export default class SyncType {
    ...
    /**
    * Returns a <code>SyncType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SyncType} The enum <code>SyncType</code> value.
    */
