...
* @readonly
*/
export default class SmtpEncryption {
    ...
    /**
    * Returns a <code>SmtpEncryption</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SmtpEncryption} The enum <code>SmtpEncryption</code> value.
    */
