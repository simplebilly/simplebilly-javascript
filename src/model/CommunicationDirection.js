...
* @readonly
*/
export default class CommunicationDirection {
    ...
    /**
    * Returns a <code>CommunicationDirection</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/CommunicationDirection} The enum <code>CommunicationDirection</code> value.
    */
