...
/**
* Enum class SupplierInvoiceStatus.
* @enum {}
* @readonly
*/
export default class SupplierInvoiceStatus {
    ...
    /**
    * Returns a <code>SupplierInvoiceStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SupplierInvoiceStatus} The enum <code>SupplierInvoiceStatus</code> value.
    */
