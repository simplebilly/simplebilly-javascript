...
* @readonly
*/
export default class TicketPriority {
    ...
    /**
    * Returns a <code>TicketPriority</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TicketPriority} The enum <code>TicketPriority</code> value.
    */
