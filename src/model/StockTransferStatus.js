...
* @readonly
*/
export default class StockTransferStatus {
    ...
    /**
    * Returns a <code>StockTransferStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/StockTransferStatus} The enum <code>StockTransferStatus</code> value.
    */
