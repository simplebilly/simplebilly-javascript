...
* @readonly
*/
export default class TrainingSource {
    ...
    /**
    * Returns a <code>TrainingSource</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/TrainingSource} The enum <code>TrainingSource</code> value.
    */
