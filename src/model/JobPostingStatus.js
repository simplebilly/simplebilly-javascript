...
* @readonly
*/
export default class JobPostingStatus {
    ...
    /**
    * Returns a <code>JobPostingStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/JobPostingStatus} The enum <code>JobPostingStatus</code> value.
    */
