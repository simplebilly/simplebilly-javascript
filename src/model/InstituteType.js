...
/**
* Enum class InstituteType.
* @enum {}
* @readonly
*/
export default class InstituteType {
        ...
        /**
         * value: "finanzdienstleistungsinstitut"
         * @const
         */
    ...
    /**
    * Returns a <code>InstituteType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/InstituteType} The enum <code>InstituteType</code> value.
    */
