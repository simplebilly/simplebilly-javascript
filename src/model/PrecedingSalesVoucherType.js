...
/**
* Enum class PrecedingSalesVoucherType.
* @enum {}
* @readonly
*/
export default class PrecedingSalesVoucherType {
    ...
    /**
    * Returns a <code>PrecedingSalesVoucherType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PrecedingSalesVoucherType} The enum <code>PrecedingSalesVoucherType</code> value.
    */
