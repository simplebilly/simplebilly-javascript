...
/**
* Enum class PosTableStatus.
* @enum {}
* @readonly
*/
export default class PosTableStatus {
    ...
    /**
    * Returns a <code>PosTableStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PosTableStatus} The enum <code>PosTableStatus</code> value.
    */
