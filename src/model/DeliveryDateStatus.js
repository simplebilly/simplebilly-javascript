...
/**
* Enum class DeliveryDateStatus.
* @enum {}
* @readonly
*/
export default class DeliveryDateStatus {
    ...
    /**
    * Returns a <code>DeliveryDateStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeliveryDateStatus} The enum <code>DeliveryDateStatus</code> value.
    */
