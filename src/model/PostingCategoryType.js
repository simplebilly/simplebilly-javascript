...
/**
* Enum class PostingCategoryType.
* @enum {}
* @readonly
*/
export default class PostingCategoryType {
    ...
    /**
    * Returns a <code>PostingCategoryType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PostingCategoryType} The enum <code>PostingCategoryType</code> value.
    */
