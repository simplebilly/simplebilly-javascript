...
* @readonly
*/
export default class ReturnOrderStatus {
    ...
    /**
    * Returns a <code>ReturnOrderStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/ReturnOrderStatus} The enum <code>ReturnOrderStatus</code> value.
    */
