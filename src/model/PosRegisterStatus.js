...
/**
* Enum class PosRegisterStatus.
* @enum {}
* @readonly
*/
export default class PosRegisterStatus {
    ...
    /**
    * Returns a <code>PosRegisterStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PosRegisterStatus} The enum <code>PosRegisterStatus</code> value.
    */
