...
* @readonly
*/
export default class SupportChannelType {
    ...
    /**
    * Returns a <code>SupportChannelType</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SupportChannelType} The enum <code>SupportChannelType</code> value.
    */
