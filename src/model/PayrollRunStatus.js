...
* @readonly
*/
export default class PayrollRunStatus {
    ...
    /**
    * Returns a <code>PayrollRunStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/PayrollRunStatus} The enum <code>PayrollRunStatus</code> value.
    */
