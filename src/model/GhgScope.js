...
export default class GhgScope {
    ...
    /**
    * Returns a <code>GhgScope</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/GhgScope} The enum <code>GhgScope</code> value.
    */
