...
/**
* Enum class DeliveryAppointmentStatus.
* @enum {}
* @readonly
*/
export default class DeliveryAppointmentStatus {
    ...
    /**
    * Returns a <code>DeliveryAppointmentStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/DeliveryAppointmentStatus} The enum <code>DeliveryAppointmentStatus</code> value.
    */
