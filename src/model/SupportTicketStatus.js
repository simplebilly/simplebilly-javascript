...
* @readonly
*/
export default class SupportTicketStatus {
    ...
    /**
    * Returns a <code>SupportTicketStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SupportTicketStatus} The enum <code>SupportTicketStatus</code> value.
    */
