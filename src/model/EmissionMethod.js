...
/**
* Enum class EmissionMethod.
* @enum {}
* @readonly
*/
export default class EmissionMethod {
    ...
    /**
    * Returns a <code>EmissionMethod</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EmissionMethod} The enum <code>EmissionMethod</code> value.
    */
