 ...
 * @module model/ServiceJob
 * @version 0.1.0
 */
class ServiceJob {
    /**
     * Constructs a new <code>ServiceJob</code>.
     * @alias module:model/ServiceJob
     */
    constructor() { 
        
        ServiceJob.initialize(this);
    }
     ...
     * @param {module:model/ServiceJob} obj Optional instance to populate.
     * @return {module:model/ServiceJob} The populated <code>ServiceJob</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ServiceJob</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ServiceJob</code>.
     */
