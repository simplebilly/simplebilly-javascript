...
/**
 * The ProductAttributeUpdate model module.
 * @module model/ProductAttributeUpdate
 * @version 0.1.0
 */
class ProductAttributeUpdate {
    /**
     * Constructs a new <code>ProductAttributeUpdate</code>.
     * @alias module:model/ProductAttributeUpdate
     */
    constructor() { 
        
        ProductAttributeUpdate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProductAttributeUpdate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProductAttributeUpdate} obj Optional instance to populate.
     * @return {module:model/ProductAttributeUpdate} The populated <code>ProductAttributeUpdate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProductAttributeUpdate();
    ...
    /**
     * Validates the JSON data with respect to <code>ProductAttributeUpdate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ProductAttributeUpdate</code>.
     */
 ...
 */
ProductAttributeUpdate.prototype['isFilterable'] = undefined;

/**
 * Attribute name, e.g. `Material`, `Farbe`, `Gewicht`.
 * @member {String} name
 */
ProductAttributeUpdate.prototype['name'] = undefined;

/**
 * Ordering position within the product's attribute list.
 * @member {Number} position
 */
ProductAttributeUpdate.prototype['position'] = undefined;

/**
 * The product this attribute belongs to. References the product entity.
 * @member {String} productId
 */
ProductAttributeUpdate.prototype['productId'] = undefined;

/**
 * Optional unit of measure for numeric attributes, e.g. `g`, `cm`.
 * @member {String} unit
 */
ProductAttributeUpdate.prototype['unit'] = undefined;

/**
 * Attribute value, e.g. `Baumwolle`, `Rot`, `180g`.
 * @member {String} value
 */
ProductAttributeUpdate.prototype['value'] = undefined;
