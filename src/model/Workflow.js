...
class Workflow {
     ...
     * @param name {String} 
     * @param triggerEvent {String} Event that triggers the workflow, e.g. `order.paid`, `order.shipped`.
     */
    constructor(name, triggerEvent) { 
        
        Workflow.initialize(this, name, triggerEvent);
    }
     ...
     */
    static initialize(obj, name, triggerEvent) { 
        obj['name'] = name;
...
Workflow.RequiredProperties = ["name", "triggerEvent"];
 ...
 */
Workflow.prototype['enabled'] = undefined;
 ...
 */
Workflow.prototype['triggerEvent'] = undefined;
