...
* @readonly
*/
export default class EmailTemplateStatus {
    ...
    /**
    * Returns a <code>EmailTemplateStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/EmailTemplateStatus} The enum <code>EmailTemplateStatus</code> value.
    */
