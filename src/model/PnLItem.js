...
/**
 * The PnLItem model module.
 * @module model/PnLItem
 * @version 0.1.0
 */
class PnLItem {
    /**
     * Constructs a new <code>PnLItem</code>.
     * @alias module:model/PnLItem
    ...
    constructor(account, accountName, amount) { 
        ...
        PnLItem.initialize(this, account, accountName, amount);
    }
    ...
    /**
     * Constructs a <code>PnLItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PnLItem} obj Optional instance to populate.
     * @return {module:model/PnLItem} The populated <code>PnLItem</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PnLItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PnLItem</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PnLItem.RequiredProperties) {
...
PnLItem.RequiredProperties = ["account", "account_name", "amount"];

/**
 * @member {String} account
 */
PnLItem.prototype['account'] = undefined;

/**
 * @member {String} account_name
 */
PnLItem.prototype['account_name'] = undefined;

/**
 * @member {String} amount
 */
PnLItem.prototype['amount'] = undefined;
