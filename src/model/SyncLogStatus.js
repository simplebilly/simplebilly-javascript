...
* @readonly
*/
export default class SyncLogStatus {
    ...
    /**
    * Returns a <code>SyncLogStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/SyncLogStatus} The enum <code>SyncLogStatus</code> value.
    */
