...
* @readonly
*/
export default class VoucherStatus {
    ...
    /**
    * Returns a <code>VoucherStatus</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/VoucherStatus} The enum <code>VoucherStatus</code> value.
    */
