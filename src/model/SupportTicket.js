...
class SupportTicket {
     ...
     * @param firstMessageAt {Date} 
     * @param lastMessageAt {Date} 
     * @param messageCount {Number} 
     * @param priority {module:model/TicketPriority} 
     * @param status {module:model/SupportTicketStatus} 
     * @param subject {String} 
     * @param tags {Object} 
     * @param tenantId {String} 
     */
    constructor(createdAt, firstMessageAt, lastMessageAt, messageCount, priority, status, subject, tags, tenantId) { 
        
        SupportTicket.initialize(this, createdAt, firstMessageAt, lastMessageAt, messageCount, priority, status, subject, tags, tenantId);
    }
     ...
     */
    static initialize(obj, createdAt, firstMessageAt, lastMessageAt, messageCount, priority, status, subject, tags, tenantId) { 
        obj['createdAt'] = createdAt;
        obj['firstMessageAt'] = firstMessageAt;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('priority')) {
                obj['priority'] = TicketPriority.constructFromObject(data['priority']);
            }
            if (data.hasOwnProperty('resolution')) {
                obj['resolution'] = ApiClient.convertToType(data['resolution'], 'String');
            }
            if (data.hasOwnProperty('status')) {
                obj['status'] = SupportTicketStatus.constructFromObject(data['status']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of SupportTicket.RequiredProperties) {
...
SupportTicket.RequiredProperties = ["createdAt", "firstMessageAt", "lastMessageAt", "messageCount", "priority", "status", "subject", "tags", "tenantId"];

/**
 * @member {String} assignedTo
 */
SupportTicket.prototype['assignedTo'] = undefined;

/**
 * @member {String} channelId
 */
SupportTicket.prototype['channelId'] = undefined;

/**
 * @member {module:model/SupportChannelType} channelType
 */
SupportTicket.prototype['channelType'] = undefined;

/**
 * @member {Date} closedAt
 */
SupportTicket.prototype['closedAt'] = undefined;

/**
 * @member {Date} createdAt
 */
SupportTicket.prototype['createdAt'] = undefined;

/**
 * @member {String} customerEmail
 */
SupportTicket.prototype['customerEmail'] = undefined;

/**
 * References the customer entity.
 * @member {String} customerId
 */
SupportTicket.prototype['customerId'] = undefined;

/**
 * @member {String} customerName
 */
SupportTicket.prototype['customerName'] = undefined;

/**
 * @member {String} externalId
 */
SupportTicket.prototype['externalId'] = undefined;

/**
 * @member {Date} firstMessageAt
 */
SupportTicket.prototype['firstMessageAt'] = undefined;

/**
 * @member {Date} lastMessageAt
 */
SupportTicket.prototype['lastMessageAt'] = undefined;

/**
 * References the lead entity.
 * @member {String} leadId
 */
SupportTicket.prototype['leadId'] = undefined;

/**
 * @member {Number} messageCount
 */
SupportTicket.prototype['messageCount'] = undefined;

/**
 * @member {String} orderRef
 */
SupportTicket.prototype['orderRef'] = undefined;

/**
 * @member {module:model/TicketPriority} priority
 */
SupportTicket.prototype['priority'] = undefined;

/**
 * @member {String} resolution
 */
SupportTicket.prototype['resolution'] = undefined;
 ...
 */
SupportTicket.prototype['subject'] = undefined;

/**
 * @member {Object} tags
 */
SupportTicket.prototype['tags'] = undefined;

/**
 * @member {String} tenantId
 */
SupportTicket.prototype['tenantId'] = undefined;

/**
 * @member {Date} updatedAt
 */
SupportTicket.prototype['updatedAt'] = undefined;
